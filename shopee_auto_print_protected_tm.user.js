...
window.addEventListener(_0xstr(10), function _0x0058(e) {
if (e.data && e.data.type === _0xstr(11) && e.data.reqId === reqId) {
window.removeEventListener(_0xstr(12), _0x0058);
if (e.data.success) {
if (options.onload) {
options.onload({
text: e.data.responseText,
...
if (_0x00a7.includes(_0x001e.hashKey)) {
return type;
}
}
return null;
...
const _0x0065 = _0x0054();
if (_0x0065) {
localStorage.setItem(_0xstr(35) + _0x0065, Date.now().toString());
localStorage.setItem(_0xstr(36) + _0x0065, _0x00d2);
}
function _0x0057() {
const _0x0033 = _0x0054();
if (_0x0033) {
...
window.addEventListener(_0xstr(41), _0x0057);
window.addEventListener(_0xstr(42), _0x0057);
function init() {
...
const _0x00e3 = _0xstr(66);
const _0x00da = _0xstr(67);
const _0x0030 = localStorage.getItem(_0x00e3);
const _0x0091 = parseInt(localStorage.getItem(_0x00da) || _0xstr(68));
const _0x00af = [_0xstr(69), _0xstr(70), _0xstr(71)];
const _0x0099 = _0x00af.indexOf(tabType);
const _0x0064 = _0x0030 ? _0x00af.indexOf(_0x0030) : 99;
if (!_0x0030 || (now - _0x0091) > 5000 || _0x0030 === tabType || (_0x0099 !== -1 && _0x0099 < _0x0064)) {
localStorage.setItem(_0x0090, _0xstr(72));
...
const _0x0090 = _0xstr(73);
const _0x00e3 = _0xstr(74);
const _0x00da = _0xstr(75);
const _0x0030 = localStorage.getItem(_0x00e3);
if (_0x0030 === tabType) {
...
const _0x00e3 = _0xstr(76);
const _0x00da = _0xstr(77);
const _0x0030 = localStorage.getItem(_0x00e3);
if (_0x0030 === tabType) {
...
let _0x009c = prompt(_0xstr(79), _0x0014);
if (_0x009c) {
_0x0014 = _0x009c.trim();
...
panel.innerHTML = _0xstr(94) + (_0x0014) + _0xstr(95) + (_0x00aa) + _0xstr(96) + (_0x00ab === _0xstr(97) ? _0xstr(98) : _0xstr(99)) + _0xstr(100) + (_0x00ab === _0xstr(101) ? _0xstr(102) : _0xstr(103)) + _0xstr(104) + (_0x00ab === _0xstr(105) ? _0xstr(106) : _0xstr(107)) + _0xstr(108);
document.body.appendChild(panel);
const _0x00df = document.createElement(_0xstr(109));
_0x00df.innerHTML = _0xstr(110);
...
const _0x0092 = document.getElementById(_0xstr(125));
const badge = document.getElementById(_0xstr(126));
const _0x00dd = document.getElementById(_0xstr(127));
const _0x00ea = document.getElementById(_0xstr(128));
const _0x00a8 = document.getElementById(_0xstr(129));
...
const _0x00eb = document.getElementById(_0xstr(133));
const _0x00e9 = document.getElementById(_0xstr(134));
const _0x0040 = document.getElementById(_0xstr(135));
const _0x00ec = document.getElementById(_0xstr(136));
const _0x00d4 = document.getElementById(_0xstr(137));
const _0x00a3 = document.getElementById(_0xstr(138));
function log(message) {
const _0x00d9 = new Date().toLocaleTimeString();
_0x0092.innerHTML = _0xstr(139) + (_0x00d9) + _0xstr(140) + (message) + _0xstr(141) + _0x0092.innerHTML;
const _0x008e = _0x0092.innerHTML.split(_0xstr(142));
if (_0x008e.length > 20) _0x0092.innerHTML = _0x008e.slice(0, 20).join(_0xstr(143));
}
function _0x00e7() {
if (_0x0076) {
badge.innerText = _0xstr(144);
badge.style.backgroundColor = _0xstr(145);
_0x00dd.innerText = _0xstr(146);
_0x00dd.style.backgroundColor = _0xstr(147);
} else {
badge.innerText = _0xstr(148);
badge.style.backgroundColor = _0xstr(149);
_0x00dd.innerText = _0xstr(150);
_0x00dd.style.backgroundColor = _0xstr(151);
}
}
function _0x00e8() {
if (_0x0014 && _0x0014 !== _0x0000) {
_0x00e9.style.display = _0xstr(152);
_0x00eb.style.display = _0xstr(153);
_0x00ec.innerText = _0xstr(154);
} else {
...
localStorage.setItem(_0xstr(158) + _0x0033, _0x00d2);
}
}
const _0x000b = 15000;
const _0x0003 = 10000;
const _0x0004 = 20000;
function _0x00e6() {
_0x00d4.innerHTML = _0xstr(159);
const now = Date.now();
for (const [type, _0x001e] of Object.entries(_0x000a)) {
const _0x0087 = parseInt(localStorage.getItem(_0xstr(160) + type) || _0xstr(161));
const _0x0078 = _0x0087 > 0 && (now - _0x0087) < _0x000b;
const _0x007b = document.createElement(_0xstr(162));
_0x007b.style = _0xstr(163) + (_0x0078 ? _0xstr(164) : _0xstr(165)) + _0xstr(166) + (_0x0078 ? _0xstr(167) : _0xstr(168)) + _0xstr(169);
_0x007b.innerHTML = _0xstr(170) + (_0x0078 ? _0xstr(171) : _0xstr(172)) + _0xstr(173) + (_0x001e.name) + _0xstr(174) + (_0x0078 ? _0xstr(175) : _0xstr(176)) + _0xstr(177) + (_0x0078 ? _0xstr(178) : _0xstr(179)) + _0xstr(180);
_0x007b.style.cursor = _0xstr(181);
_0x007b.title = _0xstr(182) + (_0x001e.name) + _0xstr(183);
_0x007b.addEventListener(_0xstr(184), () => {
...
function _0x0066(_0x00e0) {
const now = Date.now();
const _0x0047 = localStorage.getItem(_0xstr(192));
if (_0x0047) {
if (_0x00e0 === _0xstr(193)) {
log(_0xstr(194));
_0x0029();
} else {
...
if (_0x00e0 === _0xstr(198)) {
localStorage.setItem(_0xstr(199) + type, _0xstr(200));
_0x00d5.push(type);
} else {
const _0x0087 = parseInt(localStorage.getItem(_0xstr(201) + type) || _0xstr(202));
const _0x006b = _0x0087 > 0 && (now - _0x0087) < _0x000b;
if (!_0x006b) {
_0x00d5.push(type);
}
}
...
if (_0x00d5.length === 0) {
if (_0x00e0 === _0xstr(203)) log(_0xstr(204));
return;
}
localStorage.removeItem(_0xstr(205));
log(_0xstr(206) + (_0x00d5.length) + _0xstr(207) + (_0x00d5.map(t => _0x000a[t]?.name || t).join(_0xstr(208))) + _0xstr(209));
localStorage.setItem(_0xstr(210), JSON.stringify(_0x00d5));
localStorage.setItem(_0xstr(211), _0x00d5[0]);
...
const _0x004e = _0x00d5[0];
const _0x001e = _0x000a[_0x004e];
localStorage.setItem(_0xstr(216) + _0x004e, now.toString());
const _0x009a = _0x0054();
if (_0x009a === _0x004e) {
...
let _0x00b7;
try {
_0x00b7 = JSON.parse(localStorage.getItem(_0xstr(229)) || _0xstr(230));
} catch(e) {
_0x0029();
return;
}
...
const _0x001e = _0x000a[_0x009d];
const now = Date.now();
localStorage.setItem(_0xstr(231), JSON.stringify(_0x00b7));
localStorage.setItem(_0xstr(232), _0x009d);
localStorage.setItem(_0xstr(233), _0xstr(234));
localStorage.setItem(_0xstr(235), now.toString());
localStorage.setItem(_0xstr(236) + _0x009d, now.toString());
...
function _0x0056() {
const _0x00b8 = localStorage.getItem(_0xstr(245));
if (!_0x00b8) return;
let _0x00b7;
try {
...
const _0x00ac = localStorage.getItem(_0xstr(247));
if (_0x00ac !== _0xstr(248)) return;
const _0x00d3 = parseInt(localStorage.getItem(_0xstr(249)) || _0xstr(250));
const now = Date.now();
if (_0x006f()) {
log(_0xstr(251) + (_0x000a[_0x009a]?.name || _0x009a) + _0xstr(252));
_0x008a = Date.now();
_0x00a5();
return;
}
...
if (_0x00c2 < 1) {
log(_0xstr(255) + (_0x000a[_0x009a]?.name || _0x009a) + _0xstr(256));
localStorage.setItem(_0xstr(257), _0xstr(258));
localStorage.setItem(_0xstr(259), now.toString());
window.location.reload();
} else {
log(_0xstr(260) + (_0x000a[_0x009a]?.name || _0x009a) + _0xstr(261));
...
let _0x005a = false;
let _0x005d = false;
let _0x0052 = _0xstr(265);
for (const [type, _0x001e] of Object.entries(_0x000a)) {
const _0x0087 = parseInt(localStorage.getItem(_0xstr(266) + type) || _0xstr(267));
const _0x00bd = localStorage.getItem(_0xstr(268) + type);
const _0x0078 = _0x0087 > 0 && (now - _0x0087) < _0x000b;
if (!_0x0078) {
const _0x0083 = parseInt(localStorage.getItem(_0xstr(269) + type) || _0xstr(270));
...
if (_0x005d && _0x0052) {
const _0x001e = _0x000a[_0x0052];
log(_0xstr(271) + (_0x001e.name) + _0xstr(272));
localStorage.setItem(_0xstr(273) + _0x0052, now.toString());
...
const _0x0053 = [_0xstr(284), _0xstr(285), _0xstr(286), _0xstr(287), _0xstr(288)];
const _0x0055 = () => {
_0x0061 = true;
_0x0053.forEach(e => window.removeEventListener(e, _0x0055, true));
if (_0x0076) {
_0x00cc();
_0x0021();
}
};
_0x0053.forEach(e => window.addEventListener(e, _0x0055, { once: true, capture: true, passive: true }));
function _0x0021() {
}
function _0x00d0() {
}
...
if (document.visibilityState === _0xstr(290) && _0x0076) {
_0x00c0();
}
});
_0x00a3.addEventListener(_0xstr(291), _0x00a4);
_0x00e7();
_0x00e8();
if (_0x0076) {
_0x0042();
...
_0x00e9.style.display = _0xstr(293);
_0x00eb.style.display = _0xstr(294);
_0x00ea.focus();
});
_0x00c5.addEventListener(_0xstr(295), async () => {
const _0x0069 = _0x00ea.value.trim();
const _0x00a9 = _0x00a8.value.trim() || _0xstr(296);
const _0x00b0 = document.getElementById(_0xstr(297));
const _0x00b1 = _0x00b0 ? _0x00b0.value : _0xstr(298);
const _0x00a1 = localStorage.getItem(_0xstr(299)) || _0xstr(300);
if (_0x0069 && !_0x0069.includes(_0xstr(301))) {
if (_0x0069 !== _0x00a1 && _0x00a1 !== _0xstr(302)) {
...
localStorage.setItem(_0xstr(307), _0x00aa);
localStorage.setItem(_0xstr(308), _0x00ab);
GM_setValue(_0xstr(309), _0x0014);
GM_setValue(_0xstr(310), _0x00aa);
GM_setValue(_0xstr(311), _0x00ab);
log(_0xstr(312) + (_0x00aa) + _0xstr(313) + (_0x00ab) + _0xstr(314));
_0x00e8();
if (_0x0069 !== _0x00a1 && _0x00a1 !== _0xstr(315)) {
log(_0xstr(316));
try {
...
_0x0076 = !_0x0076;
localStorage.setItem(_0xstr(326), _0x0076 ? _0xstr(327) : _0xstr(328));
_0x00e7();
log(_0x0076 ? _0xstr(329) : _0xstr(330));
if (_0x0076) {
_0x0042();
_0x00a4();
} else {
...
_0x00dd.addEventListener(_0xstr(331), _0x00de);
badge.addEventListener(_0xstr(332), _0x00de);
_0x002a.addEventListener(_0xstr(333), _0x002c);
launcher.addEventListener(_0xstr(334), _0x0048);
...
const _0x009b = Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype, _0xstr(340))?.set;
if (_0x009b) {
...
let _0x00d8 = _0xstr(353);
if (method === _0xstr(354)) {
_0x00d8 = _0xstr(355) + (_0x0028) + _0xstr(356) + (urlOrAction) + _0xstr(357) + (encodeURIComponent((_0x00aa || _0xstr(358)).trim())) + _0xstr(359) + (encodeURIComponent((_0x00ab || _0xstr(360)).trim())) + _0xstr(361);
} else {
_0x00d8 = _0x0028;
}
let isSettled = false;
...
isSettled = true;
clearTimeout(timer);
reject(new Error(_0xstr(376) + (_0x00d8) + _0xstr(377)));
},
ontimeout: function() {
if (isSettled) return;
isSettled = true;
...
options.data = JSON.stringify(Object.assign({ action: urlOrAction, pc: (_0x00aa || _0xstr(383)).trim(), priority: (_0x00ab || _0xstr(384)).trim() }, data));
}
...
if (document.hidden) {
log(_0xstr(389));
window.postMessage({ type: _0xstr(390), tabInstanceId: _0x00d2 }, _0xstr(391));
for (let i = 0; i < 40; i++) {
await _0x0036(100);
if (!document.hidden) {
await _0x0036(500);
...
const _0x00c1 = await _0x0046(_0x002b);
if (_0x00c1 && _0x00c1.success) {
_0x008a = Date.now();
const _0x004a = _0x00c1.invalidCodes || [];
const _0x00d1 = _0x002b.filter(c => !_0x004a.some(f => c === f || c.includes(f)));
log(_0xstr(404) + (_0x00d1.length) + _0xstr(405) + (_0x004a.length) + _0xstr(406));
for (const code of _0x00d1) {
_0x001b(_0xstr(407), _0xstr(408), { code: code, status: _0xstr(409) })
.then(() => log(_0xstr(410) + (code) + _0xstr(411)))
.catch(e => log(_0xstr(412) + (code) + _0xstr(413) + (e.message) + _0xstr(414)));
}
for (const code of _0x004a) {
_0x001b(_0xstr(415), _0xstr(416), { code: code, status: _0xstr(417) })
.then(() => log(_0xstr(418) + (code) + _0xstr(419)))
.catch(e => log(_0xstr(420) + (code) + _0xstr(421) + (e.message) + _0xstr(422)));
}
} else {
log(_0xstr(423));
const _0x004b = (_0x00c1 && _0x00c1.invalidCodes) ? _0x00c1.invalidCodes : _0x002b;
for (const code of _0x004b) {
_0x001b(_0xstr(424), _0xstr(425), { code: code, status: _0xstr(426) })
.then(() => log(_0xstr(427) + (code) + _0xstr(428)))
.catch(e => log(_0xstr(429) + (code) + _0xstr(430) + (e.message) + _0xstr(431)));
}
}
}
} catch (error) {
log(_0xstr(432) + (error.message) + _0xstr(433));
} finally {
_0x0072 = false;
localStorage.removeItem(_0xstr(434));
_0x00be(_0xstr(435));
}
}
async function _0x0046(codes) {
await _0x0043();
let textarea = null;
for (let i = 0; i < 20; i++) {
textarea = document.querySelector(_0xstr(436)) || document.querySelector(_0xstr(437));
if (textarea) break;
await _0x0036(100);
}
if (!textarea) {
...
const _0x002d = codes.join(_0xstr(439));
...
textarea.focus();
textarea.select();
document.execCommand(_0xstr(442), false, _0x002d);
textarea.dispatchEvent(new Event(_0xstr(443), { bubbles: true }));
} catch (e) {}
await _0x0037(300, 500);
const _0x002e = Array.from(document.querySelectorAll(_0xstr(444))).find(btn => {
const _0x00e2 = btn.innerText || btn.textContent || _0xstr(445);
return _0x00e2.trim().toLowerCase() === _0xstr(446);
});
...
let _0x005c = false;
const invalidCodes = [];
const _0x00ee = codes.filter(c => c.startsWith(_0xstr(447)) || c.startsWith(_0xstr(448)) || c.startsWith(_0xstr(449)) || /^[A-Z0-9]{8,25}$/.test(c));
for (let i = 0; i < 40; i++) {
await _0x0036(50);
const _0x000f = Array.from(document.querySelectorAll(_0xstr(450)));
const _0x0051 = _0x000f.find(el => {
...
const _0x003d = document.querySelectorAll(_0xstr(451));
for (const _0x0038 of _0x003d) {
if (_0x0038.offsetWidth > 0 || _0x0038.offsetHeight > 0) {
const _0x003c = (_0x0038.innerText || _0x0038.textContent || _0xstr(452));
if (_0x003c.toLowerCase().includes(_0xstr(453)) ||
_0x003c.toLowerCase().includes(_0xstr(454)) ||
_0x003c.toLowerCase().includes(_0xstr(455)) ||
_0x003c.toLowerCase().includes(_0xstr(456)) ||
_0x003c.toLowerCase().includes(_0xstr(457))) {
_0x005c = true;
const _0x009f = Array.from(_0x0038.querySelectorAll(_0xstr(458))).find(btn => {
const _0x00e2 = (btn.innerText || btn.textContent || _0xstr(459)).trim().toLowerCase();
return _0x00e2 === _0xstr(460) || _0x00e2 === _0xstr(461) || _0x00e2 === _0xstr(462) || _0x00e2 === _0xstr(463) || _0x00e2 === _0xstr(464) || _0x00e2.includes(_0xstr(465));
});
if (_0x009f) {
const _0x00a0 = 800 + Math.random() * 200;
log(_0xstr(466) + ((_0x00a0/1000).toFixed(2)) + _0xstr(467));
await _0x0036(_0x00a0);
_0x009f.click();
log(_0xstr(468));
await _0x0036(500);
}
const _0x008e = _0x003c.split(_0xstr(469)).map(l => l.trim().toUpperCase());
for (const _0x008d of _0x008e) {
const _0x0096 = _0x008d.match(/(SPXVN\d+|TETS\d+|VN\d+|[A-Z0-9]{8,25})/g);
if (_0x0096) {
for (const match of _0x0096) {
if (!match.includes(_0xstr(470)) && !match.includes(_0xstr(471)) && !match.includes(_0xstr(472))) {
...
const _0x00ad = Array.from(document.querySelectorAll(_0xstr(474))).find(el => {
const _0x00e2 = el.innerText || el.textContent || _0xstr(475);
return _0x00e2.trim() === _0xstr(476);
});
if (!_0x00ad) return { success: false, invalidCodes: codes };
await _0x0037(400, 500);
_0x00ad.click();
let _0x003b = null;
for (let i = 0; i < 40; i++) {
await _0x0036(50);
const _0x0013 = Array.from(document.querySelectorAll(_0xstr(477))).filter(el => {
const _0x00e2 = el.innerText || el.textContent || _0xstr(478);
return _0x00e2.trim().toLowerCase() === _0xstr(479);
});
_0x003b = _0x0013.find(btn => btn !== _0x00ad);
if (_0x003b) break;
}
if (_0x003b) {
await _0x0036(300);
...
const now = Date.now();
if (now - _0x0089 > 2000) {
let _0x00c6 = Array.from(document.querySelectorAll(_0xstr(483))).find(btn => {
const text = btn.innerText.trim();
return text === _0xstr(484) || text === _0xstr(485);
});
if (_0x00c6) {
_0x00c6.click();
_0x0089 = now;
...
try {
const res = await _0x001b(_0xstr(486), _0xstr(487));
if (res.status === _0xstr(488) && Array.isArray(res.data)) {
_0x008f = new Set(res.data.map(to => to.toLowerCase()));
_0x008b = now;
log(_0xstr(489) + (_0x008f.size) + _0xstr(490));
}
} catch (e) {
log(_0xstr(491) + (e.message) + _0xstr(492));
}
}
const headers = Array.from(document.querySelectorAll(_0xstr(493)));
let _0x00db = -1;
let _0x00a2 = -1;
let _0x00b5 = -1;
headers.forEach((th, index) => {
const text = th.innerText.trim().toLowerCase();
if (text.includes(_0xstr(494)) || text.includes(_0xstr(495)) || text.includes(_0xstr(496)) || text.includes(_0xstr(497))) {
_0x00db = index;
} else if (text.includes(_0xstr(498)) || text.includes(_0xstr(499)) || text.includes(_0xstr(500)) || text.includes(_0xstr(501))) {
_0x00a2 = index;
} else if (text.includes(_0xstr(502)) || text.includes(_0xstr(503)) || text.includes(_0xstr(504)) || text.includes(_0xstr(505))) {
_0x00b5 = index;
}
});
const _0x00c4 = document.querySelectorAll(_0xstr(506));
for (let _0x00c3 of _0x00c4) {
const _0x001d = _0x00c3.querySelectorAll(_0xstr(507));
if (_0x001d.length > 0) {
let toNum = _0xstr(508);
let _0x00a6 = _0xstr(509);
let _0x00b6 = -1;
if (_0x00db !== -1 && _0x001d[_0x00db]) toNum = _0x001d[_0x00db].innerText.trim();
if (_0x00a2 !== -1 && _0x001d[_0x00a2]) _0x00a6 = _0x001d[_0x00a2].innerText.trim();
if (_0x00b5 !== -1 && _0x001d[_0x00b5]) {
const _0x00b4 = parseInt(_0x001d[_0x00b5].innerText.trim(), 10);
...
_0x001d.forEach(c => {
const _0x00e2 = c.innerText.trim();
if (_0x00e2.includes(_0xstr(510))) _0x00a6 = _0x00e2;
});
}
if (_0x00b6 === -1) {
...
const _0x00b4 = parseInt(_0x00e2, 10);
if (_0x00b4 > 0) _0x00b6 = _0x00b4;
}
});
}
if (toNum && _0x00a6 && _0x00b6 > 0) {
const _0x0077 = _0x00a6.toLowerCase() === _0xstr(511);
if (!_0x0077 && !_0x008f.has(toNum.toLowerCase())) {
_0x008f.add(toNum.toLowerCase());
try {
const _0x000e = await _0x001b(_0xstr(512), _0xstr(513), { toNum: toNum });
if (_0x000e.status === _0xstr(514)) {
log(_0xstr(515) + (toNum) + _0xstr(516) + (_0x00a6) + _0xstr(517) + (_0x00b6) + _0xstr(518));
_0x008a = Date.now();
} else if (_0x000e.status === _0xstr(519)) {
log(_0xstr(520) + (toNum) + _0xstr(521));
} else {
log(_0xstr(522) + (toNum) + _0xstr(523) + (JSON.stringify(_0x000e)) + _0xstr(524));
}
} catch (err) {
_0x008f.delete(toNum.toLowerCase());
log(_0xstr(525) + (toNum) + _0xstr(526) + (err.message) + _0xstr(527));
}
}
}
}
...
log(_0xstr(528) + (error.message) + _0xstr(529));
} finally {
_0x0074 = false;
}
}
...
if (!hash.includes(_0xstr(530))) return;
if (!_0x000c(_0xstr(531))) {
return;
}
try {
_0x0075 = true;
...
_0x00e4(_0xstr(534));
const res = await _0x001b(_0xstr(535), _0xstr(536));
if (res.status === _0xstr(537) && res.toNum) {
const _0x0031 = res.toNum;
log(_0xstr(538) + (_0x0031) + _0xstr(539));
await _0x0043();
let _0x00dc = null;
const _0x007d = document.querySelectorAll(_0xstr(540));
let _0x00d7 = null;
for (let el of _0x007d) {
const text = el.innerText.trim().toLowerCase();
if (text === _0xstr(541) || text === _0xstr(542) || text === _0xstr(543) || text === _0xstr(544)) {
_0x00d7 = el;
break;
}
}
...
_0x00dc = parent.querySelector(_0xstr(545));
if (_0x00dc) break;
parent = parent.parentElement;
}
}
if (!_0x00dc) {
const _0x0011 = document.querySelectorAll(_0xstr(546));
for (let input of _0x0011) {
const placeholder = (input.placeholder || _0xstr(547)).toLowerCase();
if (placeholder.includes(_0xstr(548)) || placeholder.includes(_0xstr(549)) || placeholder.includes(_0xstr(550)) || placeholder.includes(_0xstr(551))) {
_0x00dc = input;
break;
}
}
...
if (!_0x00dc) {
const _0x0011 = Array.from(document.querySelectorAll(_0xstr(552)));
_0x00dc = _0x0011.find(input => {
const type = (input.type || _0xstr(553)).toLowerCase();
const _0x0079 = type === _0xstr(554) || type === _0xstr(555) || type === _0xstr(556);
const _0x007a = input.style.display !== _0xstr(557) && input.style.visibility !== _0xstr(558);
return _0x0079 && _0x007a;
});
}
if (_0x00dc) {
log(_0xstr(559) + (_0x0031) + _0xstr(560));
await _0x00c8(_0x00dc, _0x0031);
await _0x0036(100);
_0x00e4(_0xstr(561));
const _0x00ae = await _0x00e1(_0x0031);
if (_0x00ae) {
log(_0xstr(562) + (_0x0031) + _0xstr(563));
_0x008a = Date.now();
try {
await _0x001b(_0xstr(564), _0xstr(565), { toNum: _0x0031 });
log(_0xstr(566) + (_0x0031) + _0xstr(567));
} catch (markErr) {
log(_0xstr(568) + (_0x0031) + _0xstr(569) + (markErr.message) + _0xstr(570));
}
} else {
log(_0xstr(571) + (_0x0031) + _0xstr(572));
try {
await _0x001b(_0xstr(573), _0xstr(574), { toNum: _0x0031, status: _0xstr(575) });
} catch (e) {
log(_0xstr(576) + (_0x0031) + _0xstr(577) + (e.message) + _0xstr(578));
}
}
} else {
log(_0xstr(579));
try {
await _0x001b(_0xstr(580), _0xstr(581), { toNum: _0x0031, status: _0xstr(582) });
log(_0xstr(583) + (_0x0031) + _0xstr(584));
} catch (e) {
log(_0xstr(585) + (_0x0031) + _0xstr(586) + (e.message) + _0xstr(587));
}
}
}
} catch (error) {
...
_0x0075 = false;
localStorage.removeItem(_0xstr(590));
_0x00be(_0xstr(591));
}
}
...
_0x0023++;
let _0x00ad = null;
const _0x0018 = document.querySelectorAll(_0xstr(592));
for (let btn of _0x0018) {
const text = btn.innerText.trim();
if (text === _0xstr(593) || text === _0xstr(594) || text === _0xstr(595) || text.includes(_0xstr(596))) {
_0x00ad = btn;
break;
}
}
if (!_0x00ad) {
const _0x0041 = document.querySelectorAll(_0xstr(597));
for (let el of _0x0041) {
const text = el.innerText.trim();
if (text === _0xstr(598) || text === _0xstr(599) || text === _0xstr(600) || text.includes(_0xstr(601))) {
_0x00ad = el.closest(_0xstr(602)) || el;
break;
}
}
}
if (_0x00ad && !_0x00ad.disabled && !_0x00ad.classList.contains(_0xstr(603))) {
clearInterval(_0x0026);
log(_0xstr(604));
_0x00ad.click();
setTimeout(() => {
log(_0xstr(605) + (_0x0031) + _0xstr(606));
resolve(true);
}, 800);
} else if (_0x0023 > 20) {
clearInterval(_0x0026);
...
const hash = window.location.hash || _0xstr(607);
if (!hash.includes(_0xstr(608))) return;
if (!_0x000c(_0xstr(609))) {
return;
}
try {
_0x0073 = true;
_0x0080 = Date.now();
localStorage.setItem(_0xstr(610), _0xstr(611));
_0x00e4(_0xstr(612));
const data = await _0x001b(_0xstr(613), _0xstr(614));
if (data.status === _0xstr(615) && data.pupCode) {
const pupCode = data.pupCode;
const _0x00b9 = data.recipientDriver;
const recipientDriver = _0x0049(_0x00b9);
const now = Date.now();
if (pupCode === _0x007f && (now - _0x0081) < 30000) {
log(_0xstr(616) + (pupCode) + _0xstr(617));
return;
}
log(_0xstr(618) + (pupCode) + _0xstr(619) + (recipientDriver) + _0xstr(620) + (_0x00b9) + _0xstr(621));
const _0x0019 = localStorage.getItem(_0xstr(622) + pupCode);
const _0x001a = parseInt(localStorage.getItem(_0xstr(623) + pupCode) || _0xstr(624));
if (_0x0019 && _0x0019 === recipientDriver && (Date.now() - _0x001a) < 1200000) {
log(_0xstr(625) + (pupCode) + _0xstr(626) + (recipientDriver) + _0xstr(627));
try {
await _0x001b(_0xstr(628), _0xstr(629), { pupCode: pupCode, status: _0xstr(630) });
log(_0xstr(631) + (pupCode) + _0xstr(632));
} catch (err) {
log(_0xstr(633) + (pupCode) + _0xstr(634) + (err.message) + _0xstr(635));
}
return;
}
const success = await _0x0045(pupCode, recipientDriver);
_0x007f = pupCode;
_0x0081 = Date.now();
if (success === true || success === _0xstr(636)) {
localStorage.setItem(_0xstr(637) + pupCode, recipientDriver);
localStorage.setItem(_0xstr(638) + pupCode, Date.now().toString());
const _0x00ce = success === _0xstr(639) ? _0xstr(640) : _0xstr(641) + (recipientDriver) + _0xstr(642);
log(_0xstr(643) + (pupCode) + _0xstr(644) + (_0x00ce) + _0xstr(645));
try {
await _0x001b(_0xstr(646), _0xstr(647), { pupCode: pupCode, status: _0xstr(648) });
log(_0xstr(649) + (pupCode) + _0xstr(650));
} catch (err) {
log(_0xstr(651) + (pupCode) + _0xstr(652) + (err.message) + _0xstr(653));
}
} else {
log(_0xstr(654));
try {
await _0x001b(_0xstr(655), _0xstr(656), { pupCode: pupCode, status: _0xstr(657) });
log(_0xstr(658) + (pupCode) + _0xstr(659));
} catch (err) {
log(_0xstr(660) + (pupCode) + _0xstr(661) + (err.message) + _0xstr(662));
}
}
} else {
localStorage.removeItem(_0xstr(663));
}
} catch (error) {
log(_0xstr(664) + (error.message) + _0xstr(665));
} finally {
_0x0073 = false;
_0x00be(_0xstr(666));
}
}
async function _0x0045(pupCode, recipientDriver) {
await _0x0043();
let _0x004d = null;
const _0x004f = document.querySelectorAll(_0xstr(667));
for (let _0x007b of _0x004f) {
const _0x007c = _0x007b.querySelector(_0xstr(668));
if (_0x007c) {
const _0x007e = (_0x007c.innerText || _0x007c.textContent || _0xstr(669)).trim().toLowerCase();
if (_0x007e.includes(_0xstr(670)) || _0x007e.includes(_0xstr(671)) || _0x007e === _0xstr(672)) {
_0x004d = _0x007b.querySelector(_0xstr(673));
if (_0x004d) break;
}
}
}
if (!_0x004d) {
const _0x0011 = document.querySelectorAll(_0xstr(674));
for (let input of _0x0011) {
const placeholder = input.placeholder || _0xstr(675);
if (placeholder.toLowerCase().includes(_0xstr(676)) || placeholder.toLowerCase().includes(_0xstr(677))) {
_0x004d = input;
break;
}
}
...
await _0x00c8(_0x004d, pupCode);
await _0x0036(300);
let _0x00c6 = Array.from(document.querySelectorAll(_0xstr(679))).find(btn => {
const _0x00e2 = btn.innerText || btn.textContent || _0xstr(680);
return _0x00e2.trim() === _0xstr(681) || _0x00e2.trim() === _0xstr(682);
});
if (_0x00c6) {
_0x00c6.click();
log(_0xstr(683) + pupCode);
} else {
_0x004d.dispatchEvent(new KeyboardEvent(_0xstr(684), { key: _0xstr(685), code: _0xstr(686), keyCode: 13, which: 13, bubbles: true }));
}
await _0x0036(2000);
_0x00e4(_0xstr(687));
const _0x009e = Array.from(document.querySelectorAll(_0xstr(688))).find(el => {
const _0x00e2 = (el.innerText || el.textContent || _0xstr(689)).trim().toLowerCase();
return _0x00e2 === _0xstr(690) || _0x00e2 === _0xstr(691);
});
if (_0x009e && (_0x009e.offsetWidth > 0 || _0x009e.offsetHeight > 0)) {
log(_0xstr(692) + (pupCode) + _0xstr(693));
return false;
}
const _0x00c4 = Array.from(document.querySelectorAll(_0xstr(694)));
const _0x0035 = _0x00c4.filter(_0x00c3 => _0x00c3.querySelector(_0xstr(695)));
if (_0x0035.length > 0) {
let _0x0050 = false;
for (let _0x00c3 of _0x0035) {
const _0x00ba = Array.from(_0x00c3.querySelectorAll(_0xstr(696))).find(el => {
const _0x00e2 = el.innerText || el.textContent || _0xstr(697);
return _0x00e2.trim() === _0xstr(698) || _0x00e2.trim() === _0xstr(699) || _0x00e2.trim() === _0xstr(700);
});
if (_0x00ba) {
_0x0050 = true;
break;
...
if (!_0x0050) {
log(_0xstr(701) + (pupCode) + _0xstr(702));
return false;
}
}
let _0x00bb = false;
for (let _0x00c3 of _0x00c4) {
const _0x00ba = Array.from(_0x00c3.querySelectorAll(_0xstr(703))).find(el => {
const _0x00e2 = el.innerText || el.textContent || _0xstr(704);
return _0x00e2.trim() === _0xstr(705) || _0x00e2.trim() === _0xstr(706) || _0x00e2.trim() === _0xstr(707);
});
if (_0x00ba) {
log(_0xstr(708));
_0x00ba.click();
await _0x0036(2500);
_0x00e4(_0xstr(709));
const _0x003d = document.querySelectorAll(_0xstr(710));
let _0x00d6 = null;
for (const _0x0038 of _0x003d) {
if (_0x0038.offsetWidth > 0 || _0x0038.offsetHeight > 0) {
const text = (_0x0038.innerText || _0x0038.textContent || _0xstr(711));
if (text.includes(_0xstr(712)) || text.includes(_0xstr(713)) || text.includes(_0xstr(714)) || text.includes(_0xstr(715))) {
_0x00d6 = _0x0038;
break;
}
}
...
if (_0x00d6) {
let _0x003f = null;
const _0x004f = _0x00d6.querySelectorAll(_0xstr(716));
for (let _0x007b of _0x004f) {
const _0x007c = _0x007b.querySelector(_0xstr(717));
if (_0x007c) {
const _0x007e = (_0x007c.innerText || _0x007c.textContent || _0xstr(718)).trim().toLowerCase();
if (_0x007e.includes(_0xstr(719)) || _0x007e.includes(_0xstr(720))) {
_0x003f = _0x007b.querySelector(_0xstr(721));
if (_0x003f) break;
}
}
}
if (!_0x003f) {
const _0x003a = _0x00d6.querySelectorAll(_0xstr(722));
for (let _0x0068 of _0x003a) {
const ph = _0x0068.placeholder || _0xstr(723);
if (ph.toLowerCase().includes(_0xstr(724)) || ph.toLowerCase().includes(_0xstr(725)) || ph.toLowerCase().includes(_0xstr(726))) {
_0x003f = _0x0068;
break;
}
}
...
if (_0x003f) {
const _0x00c7 = _0x003f.closest(_0xstr(727)) || _0x003f.parentElement;
if (_0x00c7) {
_0x00c7.click();
} else {
_0x003f.removeAttribute(_0xstr(728));
_0x003f.click();
}
log(_0xstr(729));
await _0x0036(2200);
...
if (!_0x000d || _0x000d.tagName !== _0xstr(731) || !_0x00d6.contains(_0x000d)) {
_0x000d = _0x003f;
}
_0x000d.removeAttribute(_0xstr(732));
_0x000d.focus();
if (typeof _0x000d.select === _0xstr(733)) _0x000d.select();
_0x000d.value = _0xstr(734);
_0x000d.dispatchEvent(new Event(_0xstr(735), { bubbles: true }));
try {
document.execCommand(_0xstr(736), false, recipientDriver);
} catch (e) {}
if (_0x000d.value !== recipientDriver) {
_0x000d.value = recipientDriver;
}
_0x000d.dispatchEvent(new Event(_0xstr(737), { bubbles: true }));
_0x000d.dispatchEvent(new Event(_0xstr(738), { bubbles: true }));
_0x000d.dispatchEvent(new KeyboardEvent(_0xstr(739), { key: _0xstr(740), bubbles: true }));
_0x000d.dispatchEvent(new KeyboardEvent(_0xstr(741), { key: _0xstr(742), bubbles: true }));
log(_0xstr(743) + recipientDriver + _0xstr(744));
await _0x0036(2500);
const _0x0010 = Array.from(document.querySelectorAll(_0xstr(745)));
let _0x0095 = _0x0010.find(el => {
const text = (el.innerText || el.textContent || _0xstr(746)).trim();
return text.includes(recipientDriver) &&
(el.offsetWidth > 0 || el.offsetHeight > 0) &&
(el.classList.contains(_0xstr(747)) ||
el.closest(_0xstr(748)) ||
el.closest(_0xstr(749)) ||
el.tagName === _0xstr(750));
});
if (!_0x0095) {
_0x0095 = _0x0010.find(el => {
const text = (el.innerText || el.textContent || _0xstr(751)).trim();
return text.includes(recipientDriver) &&
(el.closest(_0xstr(752)) || el.closest(_0xstr(753)) || el.tagName === _0xstr(754));
});
}
if (!_0x0095) {
_0x0095 = _0x0010.find(el => {
...
if (_0x0095) {
_0x0095.click();
log(_0xstr(756) + (_0x0095.innerText || _0x0095.textContent).trim());
await _0x0036(1200);
const _0x0039 = Array.from(_0x00d6.querySelectorAll(_0xstr(757))).find(btn => {
const _0x00e2 = btn.innerText || btn.textContent || _0xstr(758);
return _0x00e2.trim() === _0xstr(759) || _0x00e2.trim() === _0xstr(760) || _0x00e2.trim() === _0xstr(761);
});
if (_0x0039) {
_0x0039.click();
log(_0xstr(762));
...
await _0x0036(100);
const _0x0012 = Array.from(document.querySelectorAll(_0xstr(763)));
const _0x0044 = _0x0012.find(el => {
const _0x00e2 = (el.innerText || el.textContent || _0xstr(764));
return _0x00e2.includes(_0xstr(765)) || _0x00e2.includes(_0xstr(766));
});
if (_0x0044 && (_0x0044.offsetWidth > 0 || _0x0044.offsetHeight > 0)) {
log(_0xstr(767) + (_0x0044.textContent.trim()) + _0xstr(768));
_0x005b = true;
break;
}
}
if (_0x005b) {
let _0x001c = Array.from(_0x00d6.querySelectorAll(_0xstr(769))).find(btn => {
const _0x00e2 = (btn.innerText || btn.textContent || _0xstr(770)).trim().toLowerCase();
return _0x00e2 === _0xstr(771) || _0x00e2 === _0xstr(772) || _0x00e2 === _0xstr(773) || _0x00e2 === _0xstr(774) || _0x00e2.includes(_0xstr(775)) || _0x00e2.includes(_0xstr(776));
});
if (!_0x001c) {
_0x001c = Array.from(document.querySelectorAll(_0xstr(777))).find(btn => {
const _0x00e2 = (btn.innerText || btn.textContent || _0xstr(778)).trim().toLowerCase();
return (_0x00e2 === _0xstr(779) || _0x00e2 === _0xstr(780) || _0x00e2 === _0xstr(781) || _0x00e2 === _0xstr(782) || _0x00e2.includes(_0xstr(783)) || _0x00e2.includes(_0xstr(784))) &&
...
log(_0xstr(789) + recipientDriver);
}
} else {
log(_0xstr(790));
}
...
if (href.includes(_0xstr(800)) || href.includes(_0xstr(801))) {
log(_0xstr(802));
window.location.reload();
return false;
}
...
function _0x006f() {
const hash = window.location.hash || _0xstr(803);
const href = window.location.href;
if (href.includes(_0xstr(804)) || href.includes(_0xstr(805))) return false;
const _0x0094 = document.querySelectorAll(_0xstr(806));
...
if (style.display !== _0xstr(807) && style.visibility !== _0xstr(808) && style.opacity !== _0xstr(809)) {
return false;
}
}
}
if (hash.includes(_0xstr(810))) {
const textarea = document.querySelector(_0xstr(811)) || document.querySelector(_0xstr(812));
if (!textarea) return false;
const style = window.getComputedStyle(textarea);
return textarea.offsetWidth > 0 && style.display !== _0xstr(813) && style.visibility !== _0xstr(814);
}
if (hash.includes(_0xstr(815))) {
const _0x0018 = Array.from(document.querySelectorAll(_0xstr(816)));
const _0x005f = _0x0018.some(btn => {
const text = (btn.innerText || btn.textContent || _0xstr(817)).trim().toLowerCase();
const style = window.getComputedStyle(btn);
const _0x007a = btn.offsetWidth > 0 && style.display !== _0xstr(818) && style.visibility !== _0xstr(819);
return _0x007a && (text.includes(_0xstr(820)) || text.includes(_0xstr(821)));
});
const _0x0060 = document.querySelectorAll(_0xstr(822)).length > 0;
return _0x005f && _0x0060;
}
if (hash.includes(_0xstr(823))) {
const _0x006a = Array.from(document.querySelectorAll(_0xstr(824)));
const _0x0063 = _0x006a.some(input => {
const type = (input.type || _0xstr(825)).toLowerCase();
const style = window.getComputedStyle(input);
const _0x0079 = type === _0xstr(826) || type === _0xstr(827) || type === _0xstr(828);
return _0x0079 && input.offsetWidth > 0 && style.display !== _0xstr(829) && style.visibility !== _0xstr(830);
});
return _0x0063;
}
if (hash.includes(_0xstr(831))) {
const _0x006a = Array.from(document.querySelectorAll(_0xstr(832)));
const _0x005e = _0x006a.some(input => {
const style = window.getComputedStyle(input);
return input.offsetWidth > 0 && style.display !== _0xstr(833) && style.visibility !== _0xstr(834);
});
const _0x0018 = Array.from(document.querySelectorAll(_0xstr(835)));
const _0x0059 = _0x0018.some(btn => {
const style = window.getComputedStyle(btn);
return btn.offsetWidth > 0 && style.display !== _0xstr(836) && style.visibility !== _0xstr(837);
});
return _0x005e && _0x0059;
}
return false;
}
function _0x0067() {
...
log(_0xstr(838));
for (const type of _0x0002) {
localStorage.setItem(_0xstr(839) + type, _0xstr(840));
}
setTimeout(() => {
log(_0xstr(841));
_0x0066(_0xstr(842));
...
const _0x009a = _0x0054();
if (_0x009a) {
const _0x00e0 = localStorage.getItem(_0xstr(843) + _0x009a);
if (_0x00e0 === _0xstr(844)) {
localStorage.removeItem(_0xstr(845) + _0x009a);
log(_0xstr(846));
localStorage.setItem(_0xstr(847) + _0x009a, _0xstr(848));
localStorage.removeItem(_0xstr(849) + _0x009a);
window.close();
}
}
}
function _0x0025() {
const now = Date.now();
if (localStorage.getItem(_0xstr(850)) || localStorage.getItem(_0xstr(851))) return;
const _0x006d = !_0x0072 && !_0x0074 && !_0x0075 && !_0x0073;
if (_0x006d && (now - _0x008a) > _0x0001) {
_0x0067();
}
}
let _0x0098 = 0;
...
_0x00e6();
_0x0022();
_0x0014 = localStorage.getItem(_0xstr(852)) || GM_getValue(_0xstr(853), _0x0000);
_0x00aa = localStorage.getItem(_0xstr(854)) || GM_getValue(_0xstr(855), _0xstr(856));
_0x00ab = localStorage.getItem(_0xstr(857)) || GM_getValue(_0xstr(858), _0xstr(859));
_0x0076 = localStorage.getItem(_0xstr(860)) === _0xstr(861);
_0x00e7();
const _0x0034 = window.location.href;
const hash = window.location.hash || _0xstr(862);
if (_0x0034 !== _0x008c) {
_0x008c = _0x0034;
_0x0074 = false;
_0x0075 = false;
...
window.addEventListener(_0xstr(867), (e) => {
if (e.data) {
if (e.data.type === _0xstr(868)) {
_0x00e5();
if (_0x0076) {
_0x0021();
const hash = window.location.hash || _0xstr(869);
if (hash.includes(_0xstr(870))) {
_0x00cb();
} else if (hash.includes(_0xstr(871))) {
_0x00b3();
...
} else if (e.data.type === _0xstr(874)) {
log(_0xstr(875));
_0x0066(_0xstr(876));
}
}
...
let _0x00ef = null;
try {
const _0x0017 = new Blob([_0xstr(877)], { type: _0xstr(878) });
const _0x00f0 = URL.createObjectURL(_0x0017);
_0x00ef = new Worker(_0x00f0);
_0x00ef.onmessage = function(e) {
if (e.data === _0xstr(879)) {
_0x0097();
}
};
log(_0xstr(880));
...
function _0x004c() {
_0x0097();
setTimeout(_0x004c, 400);
}
_0x004c();
}
}
if (document.readyState === _0xstr(882)) {
document.addEventListener(_0xstr(883), init);
} else {
init();
}
})();
