...
const _0x0097 = parseInt(localStorage.getItem(_0x00e2) || _0xstr(69));
...
let _0x00a2 = prompt(_0xstr(80), _0x0013);
if (_0x00a2) {
_0x0013 = _0x00a2.trim();
localStorage.setItem(_0xstr(81), _0x0013);
GM_setValue(_0xstr(82), _0x0013);
alert(_0xstr(83));
...
panel.innerHTML = _0xstr(95) + (_0x0013) + _0xstr(96) + (_0x00b0) + _0xstr(97) + (_0x00b1 === _0xstr(98) ? _0xstr(99) : _0xstr(100)) + _0xstr(101) + (_0x00b1 === _0xstr(102) ? _0xstr(103) : _0xstr(104)) + _0xstr(105) + (_0x00b1 === _0xstr(106) ? _0xstr(107) : _0xstr(108)) + _0xstr(109);
...
_0x0098.innerHTML = _0xstr(140) + (_0x00e1) + _0xstr(141) + (message) + _0xstr(142) + _0x0098.innerHTML;
...
localStorage.setItem(_0xstr(159) + _0x0034, _0x00d9);
...
const _0x0004 = 20000;
function _0x00ef() {
_0x00dc.innerHTML = _0xstr(161);
const now = Date.now();
for (const [type, _0x001e] of Object.entries(_0x000a)) {
const _0x008c = parseInt(localStorage.getItem(_0xstr(162) + type) || _0xstr(163));
const _0x007b = _0x008c > 0 && (now - _0x008c) < _0x000b;
const _0x007e = document.createElement(_0xstr(164));
_0x007e.style = _0xstr(165) + (_0x007b ? _0xstr(166) : _0xstr(167)) + _0xstr(168) + (_0x007b ? _0xstr(169) : _0xstr(170)) + _0xstr(171);
_0x007e.innerHTML = _0xstr(172) + (_0x007b ? _0xstr(173) : _0xstr(174)) + _0xstr(175) + (_0x001e.name) + _0xstr(176) + (_0x007b ? _0xstr(177) : _0xstr(178)) + _0xstr(179) + (_0x007b ? _0xstr(180) : _0xstr(181)) + _0xstr(182);
_0x007e.style.cursor = _0xstr(183);
_0x007e.title = _0xstr(184) + (_0x001e.name) + _0xstr(185);
_0x007e.addEventListener(_0xstr(186), () => {
...
const now = Date.now();
const _0x0048 = localStorage.getItem(_0xstr(194));
if (_0x0048) {
if (trigger === _0xstr(195)) {
log(_0xstr(196));
_0x0029();
} else {
const _0x00d4 = parseInt(localStorage.getItem(_0xstr(197)) || _0xstr(198));
...
const _0x008c = parseInt(localStorage.getItem(_0xstr(203) + type) || _0xstr(204));
...
log(_0xstr(208) + (_0x00dd.length) + _0xstr(209) + (_0x00dd.map(t => _0x000a[t]?.name || t).join(_0xstr(210))) + _0xstr(211));
localStorage.setItem(_0xstr(212), JSON.stringify(_0x00dd));
localStorage.setItem(_0xstr(213), _0x00dd[0]);
...
localStorage.setItem(_0xstr(218) + _0x004f, now.toString());
...
let _0x00bd;
try {
_0x00bd = JSON.parse(localStorage.getItem(_0xstr(231)) || _0xstr(232));
} catch(e) {
_0x0029();
return;
}
...
const now = Date.now();
localStorage.setItem(_0xstr(233), JSON.stringify(_0x00bd));
localStorage.setItem(_0xstr(234), _0x00a3);
localStorage.setItem(_0xstr(235), _0xstr(236));
localStorage.setItem(_0xstr(237), now.toString());
localStorage.setItem(_0xstr(238) + _0x00a3, now.toString());
...
function _0x0057() {
const _0x00be = localStorage.getItem(_0xstr(247));
if (!_0x00be) return;
let _0x00bd;
try {
...
const _0x00b2 = localStorage.getItem(_0xstr(249));
if (_0x00b2 !== _0xstr(250)) return;
const _0x00da = parseInt(localStorage.getItem(_0xstr(251)) || _0xstr(252));
const now = Date.now();
if (_0x0071()) {
log(_0xstr(253) + (_0x000a[_0x00a0]?.name || _0x00a0) + _0xstr(254));
_0x008f = Date.now();
_0x00ab();
return;
}
if ((now - _0x00da) > _0x0006) {
const _0x00c9 = parseInt(localStorage.getItem(_0xstr(255)) || _0xstr(256));
if (_0x00c9 < 1) {
log(_0xstr(257) + (_0x000a[_0x00a0]?.name || _0x00a0) + _0xstr(258));
localStorage.setItem(_0xstr(259), _0xstr(260));
localStorage.setItem(_0xstr(261), now.toString());
window.location.reload();
} else {
log(_0xstr(262) + (_0x000a[_0x00a0]?.name || _0x00a0) + _0xstr(263));
...
for (const [type, _0x001e] of Object.entries(_0x000a)) {
const _0x008c = parseInt(localStorage.getItem(_0xstr(268) + type) || _0xstr(269));
const _0x00c4 = localStorage.getItem(_0xstr(270) + type);
const _0x007b = _0x008c > 0 && (now - _0x008c) < _0x000b;
if (!_0x007b) {
const _0x0088 = parseInt(localStorage.getItem(_0xstr(271) + type) || _0xstr(272));
...
_0x00a9.addEventListener(_0xstr(293), _0x00aa);
_0x00f0();
_0x00f1();
if (_0x0078) {
_0x0044();
...
_0x00cc.addEventListener(_0xstr(297), async () => {
const _0x0069 = _0x00f3.value.trim();
const _0x00af = _0x00ae.value.trim() || _0xstr(298);
const _0x00b6 = document.getElementById(_0xstr(299));
const _0x00b7 = _0x00b6 ? _0x00b6.value : _0xstr(300);
const _0x00a7 = localStorage.getItem(_0xstr(301)) || _0xstr(302);
if (_0x0069 && !_0x0069.includes(_0xstr(303))) {
if (_0x0069 !== _0x00a7 && _0x00a7 !== _0xstr(304)) {
...
localStorage.setItem(_0xstr(309), _0x00b0);
localStorage.setItem(_0xstr(310), _0x00b1);
GM_setValue(_0xstr(311), _0x0013);
GM_setValue(_0xstr(312), _0x00b0);
GM_setValue(_0xstr(313), _0x00b1);
log(_0xstr(314) + (_0x00b0) + _0xstr(315) + (_0x00b1) + _0xstr(316));
_0x00f1();
if (_0x0069 !== _0x00a7 && _0x00a7 !== _0xstr(317)) {
log(_0xstr(318));
try {
...
panel.addEventListener(_0xstr(337), _0x00d6);
...
const _0x00a1 = Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype, _0xstr(342))?.set;
if (_0x00a1) {
...
_0x00e0 = _0xstr(357) + (_0x0028) + _0xstr(358) + (urlOrAction) + _0xstr(359) + (encodeURIComponent((_0x00b0 || _0xstr(360)).trim())) + _0xstr(361) + (encodeURIComponent((_0x00b1 || _0xstr(362)).trim())) + _0xstr(363);
} else {
_0x00e0 = _0x0028;
}
let isSettled = false;
...
options.data = JSON.stringify(Object.assign({ action: urlOrAction, pc: (_0x00b0 || _0xstr(385)).trim(), priority: (_0x00b1 || _0xstr(386)).trim() }, data));
}
...
log(_0xstr(391));
window.postMessage({ type: _0xstr(392), tabInstanceId: _0x00d9 }, _0xstr(393));
for (let i = 0; i < 40; i++) {
await _0x0037(100);
if (!document.hidden && document.hasFocus()) {
await _0x0037(500);
...
log(_0xstr(405) + (_0x00d8.length) + _0xstr(406) + (_0x004b.length) + _0xstr(407));
...
_0x005d = true;
const _0x00a5 = Array.from(_0x003a.querySelectorAll(_0xstr(465))).find(btn => {
...
log(_0xstr(473) + ((_0x00a6/1000).toFixed(2)) + _0xstr(474));
await _0x0037(_0x00a6);
_0x00a5.click();
log(_0xstr(475));
await _0x0037(500);
}
const _0x0094 = _0x003e.split(_0xstr(476)).map(l => l.trim().toUpperCase());
...
const _0x00b3 = Array.from(document.querySelectorAll(_0xstr(481))).find(el => {
...
const now = Date.now();
if (now - _0x008e > 2000) {
let _0x00cd = Array.from(document.querySelectorAll(_0xstr(494))).find(btn => {
...
_0x0090 = now;
log(_0xstr(500) + (_0x0095.size) + _0xstr(501));
}
} catch (e) {
...
const _0x00cb = document.querySelectorAll(_0xstr(517));
for (let _0x00ca of _0x00cb) {
const _0x001d = _0x00ca.querySelectorAll(_0xstr(518));
if (_0x001d.length > 0) {
let toNum = _0xstr(519);
let _0x00ac = _0xstr(520);
let _0x00bc = -1;
...
_0x001d.forEach(c => {
const _0x00eb = c.innerText.trim();
if (_0x00eb.includes(_0xstr(521))) _0x00ac = _0x00eb;
});
}
if (_0x00bc === -1) {
...
const _0x007a = _0x00ac.toLowerCase() === _0xstr(522);
...
log(_0xstr(526) + (toNum) + _0xstr(527) + (_0x00ac) + _0xstr(528) + (_0x00bc) + _0xstr(529));
_0x008f = Date.now();
...
await _0x0045();
let _0x00e4 = null;
const _0x0080 = document.querySelectorAll(_0xstr(551));
let _0x00df = null;
...
const _0x007c = type === _0xstr(565) || type === _0xstr(566) || type === _0xstr(567);
const _0x007d = input.style.display !== _0xstr(568) && input.style.visibility !== _0xstr(569);
...
_0x00b3 = el.closest(_0xstr(613)) || el;
break;
}
}
}
if (_0x00b3 && !_0x00b3.disabled && !_0x00b3.classList.contains(_0xstr(614))) {
...
log(_0xstr(629) + (pupCode) + _0xstr(630) + (recipientDriver) + _0xstr(631) + (_0x00bf) + _0xstr(632));
...
const _0x00d5 = success === _0xstr(650) ? _0xstr(651) : _0xstr(652) + (recipientDriver) + _0xstr(653);
log(_0xstr(654) + (pupCode) + _0xstr(655) + (_0x00d5) + _0xstr(656));
try {
...
const _0x007f = _0x007e.querySelector(_0xstr(679));
if (_0x007f) {
const _0x0081 = (_0x007f.innerText || _0x007f.textContent || _0xstr(680)).trim().toLowerCase();
if (_0x0081.includes(_0xstr(681)) || _0x0081.includes(_0xstr(682)) || _0x0081 === _0xstr(683)) {
_0x004e = _0x007e.querySelector(_0xstr(684));
if (_0x004e) break;
}
}
}
...
await _0x0037(300);
let _0x00cd = Array.from(document.querySelectorAll(_0xstr(690))).find(btn => {
...
await _0x0037(2000);
_0x00ed(_0xstr(698));
const _0x00a4 = Array.from(document.querySelectorAll(_0xstr(699))).find(el => {
...
const _0x00cb = Array.from(document.querySelectorAll(_0xstr(705)));
const _0x0036 = _0x00cb.filter(_0x00ca => _0x00ca.querySelector(_0xstr(706)));
if (_0x0036.length > 0) {
let _0x0051 = false;
for (let _0x00ca of _0x0036) {
const _0x00c1 = Array.from(_0x00ca.querySelectorAll(_0xstr(707))).find(el => {
...
let _0x00c2 = false;
for (let _0x00ca of _0x00cb) {
const _0x00c1 = Array.from(_0x00ca.querySelectorAll(_0xstr(714))).find(el => {
...
for (let _0x007e of _0x0050) {
const _0x007f = _0x007e.querySelector(_0xstr(728));
if (_0x007f) {
const _0x0081 = (_0x007f.innerText || _0x007f.textContent || _0xstr(729)).trim().toLowerCase();
if (_0x0081.includes(_0xstr(730)) || _0x0081.includes(_0xstr(731))) {
_0x0041 = _0x007e.querySelector(_0xstr(732));
if (_0x0041) break;
}
}
}
...
const ph = _0x0068.placeholder || _0xstr(734);
...
if (_0x0041) {
const _0x00ce = _0x0041.closest(_0xstr(738)) || _0x0041.parentElement;
if (_0x00ce) {
_0x00ce.click();
} else {
...
if (_0x009b) {
_0x009b.click();
log(_0xstr(767) + (_0x009b.innerText || _0x009b.textContent).trim());
await _0x0037(1200);
...
const _0x009a = document.querySelectorAll(_0xstr(816));
...
const _0x0018 = Array.from(document.querySelectorAll(_0xstr(824)));
const _0x0060 = _0x0018.some(btn => {
const text = (btn.innerText || btn.textContent || _0xstr(825)).trim().toLowerCase();
return text.includes(_0xstr(826)) || text.includes(_0xstr(827));
});
...
return type === _0xstr(832) || type === _0xstr(833) || type === _0xstr(834);
});
return _0x005f;
}
if (hash.includes(_0xstr(835))) {
const _0x005f = document.querySelector(_0xstr(836)) !== null;
const _0x005a = document.querySelector(_0xstr(837)) !== null;
return _0x005f && _0x005a;
}
return false;
}
function _0x002b(tabType) {
log(_0xstr(838) + (tabType) + _0xstr(839));
localStorage.setItem(_0xstr(840) + tabType, _0xstr(841));
localStorage.removeItem(_0xstr(842) + tabType);
window.postMessage({ type: _0xstr(843) }, _0xstr(844));
setTimeout(() => {
try {
window.close();
} catch (e) {
console.log(_0xstr(845));
}
}, 1000);
}
function _0x0067() {
...
for (const type of _0x0002) {
if (type !== _0x00a0) {
localStorage.setItem(_0xstr(847) + type, now.toString());
}
}
setTimeout(() => {
log(_0xstr(848));
localStorage.setItem(_0xstr(849), JSON.stringify(_0x0002));
const _0x004f = _0x0002[0];
localStorage.setItem(_0xstr(850), _0x004f);
localStorage.setItem(_0xstr(851), _0xstr(852));
localStorage.setItem(_0xstr(853), Date.now().toString());
localStorage.removeItem(_0xstr(854));
if (_0x00a0 === _0x004f) {
log(_0xstr(855) + (_0x004f) + _0xstr(856));
window.location.reload();
} else {
const _0x001e = _0x000a[_0x004f];
log(_0xstr(857) + (_0x001e.name) + _0xstr(858));
window.postMessage({ type: _0xstr(859), url: _0x001e.url, active: true }, _0xstr(860));
setTimeout(() => {
log(_0xstr(861));
_0x002b(_0x00a0);
}, 1000);
...
const _0x00a0 = _0x0055();
if (_0x00a0) {
const _0x00ea = localStorage.getItem(_0xstr(862) + _0x00a0);
if (_0x00ea) {
...
_0x00ef();
_0x0022();
_0x0013 = localStorage.getItem(_0xstr(866)) || GM_getValue(_0xstr(867), _0x0000);
_0x00b0 = localStorage.getItem(_0xstr(868)) || GM_getValue(_0xstr(869), _0xstr(870));
_0x00b1 = localStorage.getItem(_0xstr(871)) || GM_getValue(_0xstr(872), _0xstr(873));
_0x0078 = localStorage.getItem(_0xstr(874)) === _0xstr(875);
_0x00f0();
const _0x0035 = window.location.href;
const hash = window.location.hash || _0xstr(876);
if (_0x0035 !== _0x0092) {
_0x0092 = _0x0035;
_0x0076 = false;
_0x0077 = false;
...
if (hash.includes(_0xstr(878))) {
_0x00b9();
}
if (hash.includes(_0xstr(879))) {
if (now - _0x0091 > 4500) {
_0x0091 = now;
_0x00b8();
}
}
if (hash.includes(_0xstr(880))) {
if (now - _0x0083 > 5000) {
_0x0083 = now;
_0x00d1();
}
...
window.addEventListener(_0xstr(881), (e) => {
if (e.data) {
if (e.data.type === _0xstr(882)) {
_0x00ee();
if (_0x0078) {
_0x0021();
const hash = window.location.hash || _0xstr(883);
if (hash.includes(_0xstr(884))) {
_0x00d2();
} else if (hash.includes(_0xstr(885))) {
_0x00b9();
} else if (hash.includes(_0xstr(886))) {
_0x00b8();
} else if (hash.includes(_0xstr(887))) {
_0x00d1();
}
}
} else if (e.data.type === _0xstr(888)) {
log(_0xstr(889));
_0x0066(_0xstr(890));
}
}
...
if (document.readyState === _0xstr(896)) {
document.addEventListener(_0xstr(897), init);
} else {
init();
}
})();
