...
try {
    (function() {
const _0x007a = window.location.host.includes(_0xstr(0)) || window.location.host.includes(_0xstr(1));
if (!_0x007a) {
return;
}
...
const _0x00ae = hash.split(_0xstr(31))[0];
for (const [type, _0x001e] of Object.entries(_0x000a)) {
if (_0x00ae.includes(_0x001e.hashKey)) {
return type;
}
}
return null;
}
let _0x00da = sessionStorage.getItem(_0xstr(32));
if (!_0x00da) {
_0x00da = _0xstr(33) + Math.random().toString(36).substring(2, 10) + _0xstr(34) + Date.now();
sessionStorage.setItem(_0xstr(35), _0x00da);
}
const _0x0067 = _0x0056();
if (_0x0067) {
localStorage.setItem(_0xstr(36) + _0x0067, Date.now().toString());
localStorage.setItem(_0xstr(37) + _0x0067, _0x00da);
}
function _0x0059() {
const _0x0034 = _0x0056();
if (_0x0034) {
const _0x00c4 = localStorage.getItem(_0xstr(38) + _0x0034);
if (_0x00c4 === _0x00da) {
...
function init() {
const _0x0074 = window.self !== window.top || window.location.href.includes(_0xstr(44)) || window.location.href.includes(_0xstr(45));
if (_0x0074) {
return;
}
const _0x0000 = _0xstr(46);
let _0x0014 = localStorage.getItem(_0xstr(47)) || GM_getValue(_0xstr(48), _0x0000);
let _0x00b1 = localStorage.getItem(_0xstr(49)) || GM_getValue(_0xstr(50), _0xstr(51));
let _0x00b2 = localStorage.getItem(_0xstr(52)) || GM_getValue(_0xstr(53), _0xstr(54));
let _0x0079 = localStorage.getItem(_0xstr(55)) === _0xstr(56);
let _0x0075 = false;
let _0x0077 = false;
let _0x0078 = false;
let _0x0076 = false;
let _0x0085 = _0xstr(57);
let _0x0087 = 0;
let _0x0093 = _0xstr(58);
let _0x008f = 0;
let _0x0096 = new Set();
let _0x0091 = 0;
let _0x008c = 0;
...
let _0x0086 = 0;
const _0x0009 = 30000;
let _0x0090 = Date.now();
const _0x0001 = 1800000;
let _0x008e = 0;
let _0x0083 = 0;
let _0x0092 = 0;
let _0x0084 = 0;
function _0x006f(myType) {
const now = Date.now();
const _0x00b6 = [_0xstr(59), _0xstr(60), _0xstr(61)];
const _0x00a0 = _0x00b6.indexOf(myType);
if (_0x00a0 === -1) return false;
const _0x000b = 12000;
for (let i = 0; i < _0x00a0; i++) {
const type = _0x00b6[i];
const _0x008d = parseInt(localStorage.getItem(_0xstr(62) + type) || _0xstr(63));
const _0x007c = _0x008d > 0 && (now - _0x008d) < _0x000b;
const _0x0073 = localStorage.getItem(_0xstr(64) + type) === _0xstr(65);
if (_0x007c && _0x0073) {
return true;
}
}
...
const _0x0097 = _0xstr(66);
const _0x00ec = _0xstr(67);
const _0x00e2 = _0xstr(68);
const _0x0031 = localStorage.getItem(_0x00ec);
const _0x0098 = parseInt(localStorage.getItem(_0x00e2) || _0xstr(69));
const _0x00b6 = [_0xstr(70), _0xstr(71), _0xstr(72)];
const _0x00a0 = _0x00b6.indexOf(tabType);
const _0x0066 = _0x0031 ? _0x00b6.indexOf(_0x0031) : 99;
if (!_0x0031 || (now - _0x0098) > 5000 || _0x0031 === tabType || (_0x00a0 !== -1 && _0x00a0 < _0x0066)) {
...
function _0x00c6(tabType) {
const _0x0097 = _0xstr(74);
const _0x00ec = _0xstr(75);
const _0x00e2 = _0xstr(76);
const _0x0031 = localStorage.getItem(_0x00ec);
if (_0x0031 === tabType) {
localStorage.removeItem(_0x0097);
...
const _0x00ec = _0xstr(77);
const _0x00e2 = _0xstr(78);
const _0x0031 = localStorage.getItem(_0x00ec);
if (_0x0031 === tabType) {
...
let _0x00a3 = prompt(_0xstr(80), _0x0014);
if (_0x00a3) {
_0x0014 = _0x00a3.trim();
...
panel.innerHTML = _0xstr(95) + (_0x0014) + _0xstr(96) + (_0x00b1) + _0xstr(97) + (_0x00b2 === _0xstr(98) ? _0xstr(99) : _0xstr(100)) + _0xstr(101) + (_0x00b2 === _0xstr(102) ? _0xstr(103) : _0xstr(104)) + _0xstr(105) + (_0x00b2 === _0xstr(106) ? _0xstr(107) : _0xstr(108)) + _0xstr(109);
document.body.appendChild(panel);
const _0x00e7 = document.createElement(_0xstr(110));
_0x00e7.innerHTML = _0xstr(111);
...
const _0x0099 = document.getElementById(_0xstr(126));
const badge = document.getElementById(_0xstr(127));
const _0x00e5 = document.getElementById(_0xstr(128));
const _0x00f3 = document.getElementById(_0xstr(129));
const _0x00af = document.getElementById(_0xstr(130));
const _0x00cd = document.getElementById(_0xstr(131));
const _0x002a = document.getElementById(_0xstr(132));
const _0x0030 = document.getElementById(_0xstr(133));
const _0x00f4 = document.getElementById(_0xstr(134));
const _0x00f2 = document.getElementById(_0xstr(135));
const _0x0042 = document.getElementById(_0xstr(136));
const _0x00f5 = document.getElementById(_0xstr(137));
const _0x00dc = document.getElementById(_0xstr(138));
const _0x00aa = document.getElementById(_0xstr(139));
function log(message) {
const _0x00e1 = new Date().toLocaleTimeString();
_0x0099.innerHTML = _0xstr(140) + (_0x00e1) + _0xstr(141) + (message) + _0xstr(142) + _0x0099.innerHTML;
const _0x0095 = _0x0099.innerHTML.split(_0xstr(143));
if (_0x0095.length > 20) _0x0099.innerHTML = _0x0095.slice(0, 20).join(_0xstr(144));
}
function _0x00f0() {
if (_0x0079) {
badge.innerText = _0xstr(145);
badge.style.backgroundColor = _0xstr(146);
_0x00e5.innerText = _0xstr(147);
_0x00e5.style.backgroundColor = _0xstr(148);
} else {
badge.innerText = _0xstr(149);
badge.style.backgroundColor = _0xstr(150);
_0x00e5.innerText = _0xstr(151);
_0x00e5.style.backgroundColor = _0xstr(152);
}
}
function _0x00f1() {
if (_0x0014 && _0x0014 !== _0x0000) {
_0x00f2.style.display = _0xstr(153);
_0x00f4.style.display = _0xstr(154);
_0x00f5.innerText = _0xstr(155);
} else {
_0x00f2.style.display = _0xstr(156);
_0x00f4.style.display = _0xstr(157);
}
}
function _0x00ee() {
const _0x0034 = _0x0056();
...
localStorage.setItem(_0xstr(159) + _0x0034, _0x00da);
}
}
const _0x000b = 15000;
const _0x0003 = 10000;
const _0x0004 = 20000;
function _0x00ef() {
_0x00dc.innerHTML = _0xstr(160);
const now = Date.now();
for (const [type, _0x001e] of Object.entries(_0x000a)) {
const _0x008d = parseInt(localStorage.getItem(_0xstr(161) + type) || _0xstr(162));
const _0x007c = _0x008d > 0 && (now - _0x008d) < _0x000b;
const _0x007f = document.createElement(_0xstr(163));
_0x007f.style = _0xstr(164) + (_0x007c ? _0xstr(165) : _0xstr(166)) + _0xstr(167) + (_0x007c ? _0xstr(168) : _0xstr(169)) + _0xstr(170);
_0x007f.innerHTML = _0xstr(171) + (_0x007c ? _0xstr(172) : _0xstr(173)) + _0xstr(174) + (_0x001e.name) + _0xstr(175) + (_0x007c ? _0xstr(176) : _0xstr(177)) + _0xstr(178) + (_0x007c ? _0xstr(179) : _0xstr(180)) + _0xstr(181);
_0x007f.style.cursor = _0xstr(182);
_0x007f.title = _0xstr(183) + (_0x001e.name) + _0xstr(184);
_0x007f.addEventListener(_0xstr(185), () => {
...
const now = Date.now();
const _0x0049 = localStorage.getItem(_0xstr(193));
if (_0x0049) {
if (trigger === _0xstr(194)) {
log(_0xstr(195));
_0x0029();
} else {
const _0x00d5 = parseInt(localStorage.getItem(_0xstr(196)) || _0xstr(197));
if ((now - _0x00d5) < 300000) {
return;
}
log(_0xstr(198));
_0x0029();
...
const _0x008d = parseInt(localStorage.getItem(_0xstr(202) + type) || _0xstr(203));
const _0x006d = _0x008d > 0 && (now - _0x008d) < _0x000b;
if (!_0x006d) {
_0x00dd.push(type);
}
}
...
log(_0xstr(207) + (_0x00dd.length) + _0xstr(208) + (_0x00dd.map(t => _0x000a[t]?.name || t).join(_0xstr(209))) + _0xstr(210));
localStorage.setItem(_0xstr(211), JSON.stringify(_0x00dd));
localStorage.setItem(_0xstr(212), _0x00dd[0]);
...
const _0x0050 = _0x00dd[0];
const _0x001e = _0x000a[_0x0050];
localStorage.setItem(_0xstr(217) + _0x0050, now.toString());
const _0x00a1 = _0x0056();
if (_0x00a1 === _0x0050) {
...
let _0x00be;
try {
_0x00be = JSON.parse(localStorage.getItem(_0xstr(230)) || _0xstr(231));
} catch(e) {
_0x0029();
return;
}
_0x00be.shift();
if (_0x00be.length > 0) {
const _0x00a4 = _0x00be[0];
const _0x001e = _0x000a[_0x00a4];
const now = Date.now();
localStorage.setItem(_0xstr(232), JSON.stringify(_0x00be));
localStorage.setItem(_0xstr(233), _0x00a4);
localStorage.setItem(_0xstr(234), _0xstr(235));
localStorage.setItem(_0xstr(236), now.toString());
localStorage.setItem(_0xstr(237) + _0x00a4, now.toString());
...
function _0x0058() {
const _0x00bf = localStorage.getItem(_0xstr(248));
if (!_0x00bf) return;
let _0x00be;
try {
_0x00be = JSON.parse(_0x00bf);
} catch(e) {
_0x0029();
return;
}
if (!Array.isArray(_0x00be) || _0x00be.length === 0) {
_0x0029();
return;
}
const _0x0033 = localStorage.getItem(_0xstr(249));
const _0x00a1 = _0x0056();
if (!_0x00a1 || _0x00a1 !== _0x0033) return;
const _0x00b3 = localStorage.getItem(_0xstr(250));
if (_0x00b3 !== _0xstr(251)) return;
const _0x00db = parseInt(localStorage.getItem(_0xstr(252)) || _0xstr(253));
const now = Date.now();
if (_0x0072()) {
log(_0xstr(254) + (_0x000a[_0x00a1]?.name || _0x00a1) + _0xstr(255));
_0x0090 = Date.now();
_0x00ac();
return;
}
if ((now - _0x00db) > _0x0006) {
const _0x00ca = parseInt(localStorage.getItem(_0xstr(256)) || _0xstr(257));
if (_0x00ca < 1) {
log(_0xstr(258) + (_0x000a[_0x00a1]?.name || _0x00a1) + _0xstr(259));
localStorage.setItem(_0xstr(260), _0xstr(261));
localStorage.setItem(_0xstr(262), now.toString());
window.location.reload();
} else {
log(_0xstr(263) + (_0x000a[_0x00a1]?.name || _0x00a1) + _0xstr(264));
...
let _0x005c = false;
let _0x005f = false;
let _0x0054 = _0xstr(268);
for (const [type, _0x001e] of Object.entries(_0x000a)) {
const _0x008d = parseInt(localStorage.getItem(_0xstr(269) + type) || _0xstr(270));
const _0x00c5 = localStorage.getItem(_0xstr(271) + type);
const _0x007c = _0x008d > 0 && (now - _0x008d) < _0x000b;
if (!_0x007c) {
const _0x0089 = parseInt(localStorage.getItem(_0xstr(272) + type) || _0xstr(273));
...
localStorage.setItem(_0xstr(276) + _0x0054, now.toString());
...
const _0x0055 = [_0xstr(287), _0xstr(288), _0xstr(289), _0xstr(290), _0xstr(291)];
const _0x0057 = () => {
_0x0063 = true;
...
if (document.visibilityState === _0xstr(293) && _0x0079) {
_0x00c8();
}
});
_0x00aa.addEventListener(_0xstr(294), _0x00ab);
_0x00f0();
_0x00f1();
if (_0x0079) {
_0x0044();
}
_0x0042.addEventListener(_0xstr(295), () => {
_0x00f2.style.display = _0xstr(296);
_0x00f4.style.display = _0xstr(297);
_0x00f3.focus();
});
_0x00cd.addEventListener(_0xstr(298), async () => {
const _0x006b = _0x00f3.value.trim();
const _0x00b0 = _0x00af.value.trim() || _0xstr(299);
const _0x00b7 = document.getElementById(_0xstr(300));
const _0x00b8 = _0x00b7 ? _0x00b7.value : _0xstr(301);
const _0x00a8 = localStorage.getItem(_0xstr(302)) || _0xstr(303);
if (_0x006b && !_0x006b.includes(_0xstr(304))) {
if (_0x006b !== _0x00a8 && _0x00a8 !== _0xstr(305)) {
...
localStorage.setItem(_0xstr(310), _0x00b1);
localStorage.setItem(_0xstr(311), _0x00b2);
GM_setValue(_0xstr(312), _0x0014);
GM_setValue(_0xstr(313), _0x00b1);
GM_setValue(_0xstr(314), _0x00b2);
log(_0xstr(315) + (_0x00b1) + _0xstr(316) + (_0x00b2) + _0xstr(317));
_0x00f1();
if (_0x006b !== _0x00a8 && _0x00a8 !== _0xstr(318)) {
log(_0xstr(319));
try {
...
_0x0079 = !_0x0079;
localStorage.setItem(_0xstr(329), _0x0079 ? _0xstr(330) : _0xstr(331));
_0x00f0();
log(_0x0079 ? _0xstr(332) : _0xstr(333));
if (_0x0079) {
_0x0044();
_0x00ab();
} else {
...
_0x00e5.addEventListener(_0xstr(334), _0x00e6);
badge.addEventListener(_0xstr(335), _0x00e6);
_0x002a.addEventListener(_0xstr(336), _0x002d);
launcher.addEventListener(_0xstr(337), _0x004a);
...
panel.addEventListener(_0xstr(342), _0x00d1);
function _0x0037(ms) {
...
async function _0x00d0(inputEl, value) {
try {
inputEl.focus();
} catch (e) {}
const _0x00a2 = Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype, _0xstr(343))?.set;
if (_0x00a2) {
...
let _0x00e0 = _0xstr(356);
if (method === _0xstr(357)) {
_0x00e0 = _0xstr(358) + (_0x0028) + _0xstr(359) + (urlOrAction) + _0xstr(360) + (encodeURIComponent((_0x00b1 || _0xstr(361)).trim())) + _0xstr(362) + (encodeURIComponent((_0x00b2 || _0xstr(363)).trim())) + _0xstr(364);
} else {
_0x00e0 = _0x0028;
}
let isSettled = false;
...
isSettled = true;
clearTimeout(timer);
reject(new Error(_0xstr(379) + (_0x00e0) + _0xstr(380)));
},
ontimeout: function() {
if (isSettled) return;
isSettled = true;
...
options.data = JSON.stringify(Object.assign({ action: urlOrAction, pc: (_0x00b1 || _0xstr(386)).trim(), priority: (_0x00b2 || _0xstr(387)).trim() }, data));
}
...
log(_0xstr(392));
window.postMessage({ type: _0xstr(393), tabInstanceId: _0x00da }, _0xstr(394));
for (let i = 0; i < 40; i++) {
await _0x0037(100);
if (!document.hidden && document.hasFocus()) {
await _0x0037(500);
...
_0x002c = _0x009d ? _0x009d.filter(c => c.trim().length > 0) : [];
} else if (data.codes && Array.isArray(data.codes)) {
_0x002c = data.codes.map(c => c.trim().toUpperCase());
}
}
if (_0x002c.length > 0) {
log(_0xstr(404) + (_0x002c.length) + _0xstr(405));
const _0x00c9 = await _0x0048(_0x002c);
if (_0x00c9 && _0x00c9.success) {
_0x0090 = Date.now();
const _0x004c = _0x00c9.invalidCodes || [];
const _0x00d9 = _0x002c.filter(c => !_0x004c.some(f => c === f || c.includes(f)));
log(_0xstr(406) + (_0x00d9.length) + _0xstr(407) + (_0x004c.length) + _0xstr(408));
...
log(_0xstr(425));
const _0x004d = (_0x00c9 && _0x00c9.invalidCodes) ? _0x00c9.invalidCodes : _0x002c;
...
const _0x002e = codes.join(_0xstr(441));
...
textarea.focus();
textarea.select();
document.execCommand(_0xstr(444), false, _0x002e);
textarea.dispatchEvent(new Event(_0xstr(445), { bubbles: true }));
} catch (e) {}
await _0x0038(300, 500);
const _0x002f = Array.from(document.querySelectorAll(_0xstr(446))).find(btn => {
const _0x00eb = btn.innerText || btn.textContent || _0xstr(447);
return _0x00eb.trim().toLowerCase() === _0xstr(448);
});
...
let _0x005e = false;
const invalidCodes = [];
const _0x00f7 = codes.filter(c => c.startsWith(_0xstr(449)) || c.startsWith(_0xstr(450)) || c.startsWith(_0xstr(451)) || /^[A-Z0-9]{8,25}$/.test(c));
for (let i = 0; i < 40; i++) {
await _0x0037(50);
...
const _0x003f = document.querySelectorAll(_0xstr(453));
for (const _0x003a of _0x003f) {
if (_0x003a.offsetWidth > 0 || _0x003a.offsetHeight > 0) {
const _0x003e = (_0x003a.innerText || _0x003a.textContent || _0xstr(454));
if (_0x003e.toLowerCase().includes(_0xstr(455)) ||
...
_0x005e = true;
const _0x00a6 = Array.from(_0x003a.querySelectorAll(_0xstr(466))).find(btn => {
const _0x00eb = (btn.innerText || btn.textContent || _0xstr(467)).trim().toLowerCase();
return _0x00eb === _0xstr(468) || _0x00eb === _0xstr(469) || _0x00eb === _0xstr(470) || _0x00eb === _0xstr(471) || _0x00eb === _0xstr(472) || _0x00eb.includes(_0xstr(473));
});
if (_0x00a6) {
const _0x00a7 = 800 + Math.random() * 200;
log(_0xstr(474) + ((_0x00a7/1000).toFixed(2)) + _0xstr(475));
await _0x0037(_0x00a7);
_0x00a6.click();
log(_0xstr(476));
await _0x0037(500);
}
const _0x0095 = _0x003e.split(_0xstr(477)).map(l => l.trim().toUpperCase());
for (const _0x0094 of _0x0095) {
const _0x009d = _0x0094.match(/(SPXVN\d+|TETS\d+|VN\d+|[A-Z0-9]{8,25})/g);
if (_0x009d) {
for (const match of _0x009d) {
if (!match.includes(_0xstr(478)) && !match.includes(_0xstr(479)) && !match.includes(_0xstr(480))) {
...
const _0x00b4 = Array.from(document.querySelectorAll(_0xstr(482))).find(el => {
const _0x00eb = el.innerText || el.textContent || _0xstr(483);
return _0x00eb.trim().toLowerCase() === _0xstr(484);
});
...
for (let i = 0; i < 40; i++) {
await _0x0037(50);
const _0x000f = Array.from(document.querySelectorAll(_0xstr(485))).filter(btn => {
const _0x00eb = btn.innerText || btn.textContent || _0xstr(486);
return _0x00eb.trim().toLowerCase() === _0xstr(487);
});
_0x003d = _0x000f.find(btn => {
let parent = btn.parentElement;
let _0x0039 = 0;
while (parent && _0x0039 < 4) {
const textContent = (parent.innerText || parent.textContent || _0xstr(488)).toLowerCase();
if (textContent.includes(_0xstr(489)) || textContent.includes(_0xstr(490)) || textContent.includes(_0xstr(491))) {
return true;
}
...
const now = Date.now();
if (now - _0x008f > 2000) {
let _0x00ce = Array.from(document.querySelectorAll(_0xstr(495))).find(btn => {
const text = btn.innerText.trim();
return text === _0xstr(496) || text === _0xstr(497);
});
if (_0x00ce) {
_0x00ce.click();
_0x008f = now;
...
try {
const res = await _0x001b(_0xstr(498), _0xstr(499));
if (res.status === _0xstr(500) && Array.isArray(res.data)) {
_0x0096 = new Set(res.data.map(to => to.toLowerCase()));
_0x0091 = now;
log(_0xstr(501) + (_0x0096.size) + _0xstr(502));
}
} catch (e) {
log(_0xstr(503) + (e.message) + _0xstr(504));
}
}
const headers = Array.from(document.querySelectorAll(_0xstr(505)));
let _0x00e3 = -1;
let _0x00a9 = -1;
let _0x00bc = -1;
headers.forEach((th, index) => {
const text = th.innerText.trim().toLowerCase();
if (text.includes(_0xstr(506)) || text.includes(_0xstr(507)) || text.includes(_0xstr(508)) || text.includes(_0xstr(509))) {
_0x00e3 = index;
} else if (text.includes(_0xstr(510)) || text.includes(_0xstr(511)) || text.includes(_0xstr(512)) || text.includes(_0xstr(513))) {
_0x00a9 = index;
} else if (text.includes(_0xstr(514)) || text.includes(_0xstr(515)) || text.includes(_0xstr(516)) || text.includes(_0xstr(517))) {
_0x00bc = index;
}
});
const _0x00cc = document.querySelectorAll(_0xstr(518));
for (let _0x00cb of _0x00cc) {
const _0x001d = _0x00cb.querySelectorAll(_0xstr(519));
if (_0x001d.length > 0) {
let toNum = _0xstr(520);
let _0x00ad = _0xstr(521);
let _0x00bd = -1;
...
if (_0x00bc !== -1 && _0x001d[_0x00bc]) {
const _0x00bb = parseInt(_0x001d[_0x00bc].innerText.trim(), 10);
if (!isNaN(_0x00bb)) _0x00bd = _0x00bb;
}
if (!toNum) {
_0x001d.forEach(c => {
...
_0x001d.forEach(c => {
const _0x00eb = c.innerText.trim();
if (_0x00eb.includes(_0xstr(522))) _0x00ad = _0x00eb;
});
}
if (_0x00bd === -1) {
...
const _0x00bb = parseInt(_0x00eb, 10);
if (_0x00bb > 0) _0x00bd = _0x00bb;
}
});
}
if (toNum && _0x00ad && _0x00bd > 0) {
const _0x007b = _0x00ad.toLowerCase() === _0xstr(523);
if (!_0x007b && !_0x0096.has(toNum.toLowerCase())) {
_0x0096.add(toNum.toLowerCase());
try {
const _0x000e = await _0x001b(_0xstr(524), _0xstr(525), { toNum: toNum });
if (_0x000e.status === _0xstr(526)) {
log(_0xstr(527) + (toNum) + _0xstr(528) + (_0x00ad) + _0xstr(529) + (_0x00bd) + _0xstr(530));
_0x0090 = Date.now();
} else if (_0x000e.status === _0xstr(531)) {
log(_0xstr(532) + (toNum) + _0xstr(533));
} else {
log(_0xstr(534) + (toNum) + _0xstr(535) + (JSON.stringify(_0x000e)) + _0xstr(536));
}
} catch (err) {
_0x0096.delete(toNum.toLowerCase());
log(_0xstr(537) + (toNum) + _0xstr(538) + (err.message) + _0xstr(539));
}
}
}
}
...
log(_0xstr(540) + (error.message) + _0xstr(541));
} finally {
_0x0077 = false;
}
}
...
if (!_0x000c(_0xstr(543))) {
return;
}
try {
_0x0078 = true;
_0x008b = Date.now();
localStorage.setItem(_0xstr(544), _0xstr(545));
_0x00ed(_0xstr(546));
const res = await _0x001b(_0xstr(547), _0xstr(548));
if (res.status === _0xstr(549) && res.toNum) {
const _0x0032 = res.toNum;
log(_0xstr(550) + (_0x0032) + _0xstr(551));
await _0x0045();
let _0x00e4 = null;
const _0x0081 = document.querySelectorAll(_0xstr(552));
let _0x00df = null;
for (let el of _0x0081) {
const text = el.innerText.trim().toLowerCase();
if (text === _0xstr(553) || text === _0xstr(554) || text === _0xstr(555) || text === _0xstr(556)) {
_0x00df = el;
break;
}
}
...
_0x00e4 = parent.querySelector(_0xstr(557));
if (_0x00e4) break;
parent = parent.parentElement;
}
}
if (!_0x00e4) {
const _0x0012 = document.querySelectorAll(_0xstr(558));
for (let input of _0x0012) {
const placeholder = (input.placeholder || _0xstr(559)).toLowerCase();
if (placeholder.includes(_0xstr(560)) || placeholder.includes(_0xstr(561)) || placeholder.includes(_0xstr(562)) || placeholder.includes(_0xstr(563))) {
_0x00e4 = input;
break;
}
}
...
if (!_0x00e4) {
const _0x0012 = Array.from(document.querySelectorAll(_0xstr(564)));
_0x00e4 = _0x0012.find(input => {
const type = (input.type || _0xstr(565)).toLowerCase();
const _0x007d = type === _0xstr(566) || type === _0xstr(567) || type === _0xstr(568);
const _0x007e = input.style.display !== _0xstr(569) && input.style.visibility !== _0xstr(570);
return _0x007d && _0x007e;
});
}
if (_0x00e4) {
log(_0xstr(571) + (_0x0032) + _0xstr(572));
await _0x00d0(_0x00e4, _0x0032);
await _0x0037(100);
_0x00ed(_0xstr(573));
const _0x00b5 = await _0x00e8(_0x0032);
if (_0x00b5) {
log(_0xstr(574) + (_0x0032) + _0xstr(575));
_0x0090 = Date.now();
try {
await _0x001b(_0xstr(576), _0xstr(577), { toNum: _0x0032 });
log(_0xstr(578) + (_0x0032) + _0xstr(579));
} catch (markErr) {
log(_0xstr(580) + (_0x0032) + _0xstr(581) + (markErr.message) + _0xstr(582));
}
} else {
log(_0xstr(583) + (_0x0032) + _0xstr(584));
try {
await _0x001b(_0xstr(585), _0xstr(586), { toNum: _0x0032, status: _0xstr(587) });
} catch (e) {
log(_0xstr(588) + (_0x0032) + _0xstr(589) + (e.message) + _0xstr(590));
}
}
} else {
log(_0xstr(591));
try {
await _0x001b(_0xstr(592), _0xstr(593), { toNum: _0x0032, status: _0xstr(594) });
log(_0xstr(595) + (_0x0032) + _0xstr(596));
} catch (e) {
log(_0xstr(597) + (_0x0032) + _0xstr(598) + (e.message) + _0xstr(599));
}
}
}
} catch (error) {
log(_0xstr(600) + (error.message) + _0xstr(601));
} finally {
_0x0078 = false;
localStorage.removeItem(_0xstr(602));
_0x00c6(_0xstr(603));
}
}
...
_0x0023++;
let _0x00b4 = null;
const _0x0018 = document.querySelectorAll(_0xstr(604));
for (let btn of _0x0018) {
const text = btn.innerText.trim();
if (text === _0xstr(605) || text === _0xstr(606) || text === _0xstr(607) || text.includes(_0xstr(608))) {
_0x00b4 = btn;
break;
}
}
if (!_0x00b4) {
const _0x0043 = document.querySelectorAll(_0xstr(609));
for (let el of _0x0043) {
const text = el.innerText.trim();
if (text === _0xstr(610) || text === _0xstr(611) || text === _0xstr(612) || text.includes(_0xstr(613))) {
_0x00b4 = el.closest(_0xstr(614)) || el;
break;
}
}
}
if (_0x00b4 && !_0x00b4.disabled && !_0x00b4.classList.contains(_0xstr(615))) {
clearInterval(_0x0026);
log(_0xstr(616));
_0x00b4.click();
setTimeout(() => {
log(_0xstr(617) + (_0x0032) + _0xstr(618));
resolve(true);
}, 800);
} else if (_0x0023 > 20) {
clearInterval(_0x0026);
...
const hash = window.location.hash || _0xstr(619);
if (!hash.includes(_0xstr(620))) return;
if (!_0x000c(_0xstr(621))) {
return;
}
try {
_0x0076 = true;
_0x0086 = Date.now();
localStorage.setItem(_0xstr(622), _0xstr(623));
_0x00ed(_0xstr(624));
const data = await _0x001b(_0xstr(625), _0xstr(626));
if (data.status === _0xstr(627) && data.pupCode) {
const pupCode = data.pupCode;
const _0x00c0 = data.recipientDriver;
const recipientDriver = _0x004b(_0x00c0);
const now = Date.now();
if (pupCode === _0x0085 && (now - _0x0087) < 30000) {
log(_0xstr(628) + (pupCode) + _0xstr(629));
return;
}
log(_0xstr(630) + (pupCode) + _0xstr(631) + (recipientDriver) + _0xstr(632) + (_0x00c0) + _0xstr(633));
const _0x0019 = localStorage.getItem(_0xstr(634) + pupCode);
const _0x001a = parseInt(localStorage.getItem(_0xstr(635) + pupCode) || _0xstr(636));
if (_0x0019 && _0x0019 === recipientDriver && (Date.now() - _0x001a) < 1200000) {
log(_0xstr(637) + (pupCode) + _0xstr(638) + (recipientDriver) + _0xstr(639));
try {
await _0x001b(_0xstr(640), _0xstr(641), { pupCode: pupCode, status: _0xstr(642) });
...
_0x0085 = pupCode;
_0x0087 = Date.now();
if (success === true || success === _0xstr(648)) {
localStorage.setItem(_0xstr(649) + pupCode, recipientDriver);
localStorage.setItem(_0xstr(650) + pupCode, Date.now().toString());
const _0x00d6 = success === _0xstr(651) ? _0xstr(652) : _0xstr(653) + (recipientDriver) + _0xstr(654);
log(_0xstr(655) + (pupCode) + _0xstr(656) + (_0x00d6) + _0xstr(657));
try {
...
log(_0xstr(666));
try {
await _0x001b(_0xstr(667), _0xstr(668), { pupCode: pupCode, status: _0xstr(669) });
log(_0xstr(670) + (pupCode) + _0xstr(671));
} catch (err) {
log(_0xstr(672) + (pupCode) + _0xstr(673) + (err.message) + _0xstr(674));
}
}
} else {
localStorage.removeItem(_0xstr(675));
}
} catch (error) {
log(_0xstr(676) + (error.message) + _0xstr(677));
} finally {
_0x0076 = false;
_0x00c6(_0xstr(678));
}
...
await _0x0045();
let _0x004f = null;
const _0x0051 = document.querySelectorAll(_0xstr(679));
for (let _0x007f of _0x0051) {
const _0x0080 = _0x007f.querySelector(_0xstr(680));
if (_0x0080) {
const _0x0082 = (_0x0080.innerText || _0x0080.textContent || _0xstr(681)).trim().toLowerCase();
if (_0x0082.includes(_0xstr(682)) || _0x0082.includes(_0xstr(683)) || _0x0082 === _0xstr(684)) {
_0x004f = _0x007f.querySelector(_0xstr(685));
if (_0x004f) break;
}
}
}
if (!_0x004f) {
const _0x0012 = document.querySelectorAll(_0xstr(686));
for (let input of _0x0012) {
const placeholder = input.placeholder || _0xstr(687);
if (placeholder.toLowerCase().includes(_0xstr(688)) || placeholder.toLowerCase().includes(_0xstr(689))) {
_0x004f = input;
break;
}
}
...
await _0x00d0(_0x004f, pupCode);
await _0x0037(300);
let _0x00ce = Array.from(document.querySelectorAll(_0xstr(691))).find(btn => {
const _0x00eb = btn.innerText || btn.textContent || _0xstr(692);
return _0x00eb.trim() === _0xstr(693) || _0x00eb.trim() === _0xstr(694);
});
if (_0x00ce) {
_0x00ce.click();
log(_0xstr(695) + pupCode);
} else {
_0x004f.dispatchEvent(new KeyboardEvent(_0xstr(696), { key: _0xstr(697), code: _0xstr(698), keyCode: 13, which: 13, bubbles: true }));
}
await _0x0037(2000);
_0x00ed(_0xstr(699));
const _0x00a5 = Array.from(document.querySelectorAll(_0xstr(700))).find(el => {
const _0x00eb = (el.innerText || el.textContent || _0xstr(701)).trim().toLowerCase();
return _0x00eb === _0xstr(702) || _0x00eb === _0xstr(703);
});
if (_0x00a5 && (_0x00a5.offsetWidth > 0 || _0x00a5.offsetHeight > 0)) {
log(_0xstr(704) + (pupCode) + _0xstr(705));
return false;
}
const _0x00cc = Array.from(document.querySelectorAll(_0xstr(706)));
const _0x0036 = _0x00cc.filter(_0x00cb => _0x00cb.querySelector(_0xstr(707)));
if (_0x0036.length > 0) {
let _0x0052 = false;
for (let _0x00cb of _0x0036) {
const _0x00c2 = Array.from(_0x00cb.querySelectorAll(_0xstr(708))).find(el => {
const _0x00eb = el.innerText || el.textContent || _0xstr(709);
return _0x00eb.trim() === _0xstr(710) || _0x00eb.trim() === _0xstr(711) || _0x00eb.trim() === _0xstr(712);
});
if (_0x00c2) {
_0x0052 = true;
break;
...
if (!_0x0052) {
log(_0xstr(713) + (pupCode) + _0xstr(714));
return false;
}
}
let _0x00c3 = false;
for (let _0x00cb of _0x00cc) {
const _0x00c2 = Array.from(_0x00cb.querySelectorAll(_0xstr(715))).find(el => {
const _0x00eb = el.innerText || el.textContent || _0xstr(716);
return _0x00eb.trim() === _0xstr(717) || _0x00eb.trim() === _0xstr(718) || _0x00eb.trim() === _0xstr(719);
});
if (_0x00c2) {
log(_0xstr(720));
_0x00c2.click();
await _0x0037(2500);
_0x00ed(_0xstr(721));
const _0x003f = document.querySelectorAll(_0xstr(722));
let _0x00de = null;
for (const _0x003a of _0x003f) {
if (_0x003a.offsetWidth > 0 || _0x003a.offsetHeight > 0) {
const text = (_0x003a.innerText || _0x003a.textContent || _0xstr(723));
if (text.includes(_0xstr(724)) || text.includes(_0xstr(725)) || text.includes(_0xstr(726)) || text.includes(_0xstr(727))) {
_0x00de = _0x003a;
break;
}
}
...
if (_0x00de) {
let _0x0041 = null;
const _0x0051 = _0x00de.querySelectorAll(_0xstr(728));
for (let _0x007f of _0x0051) {
const _0x0080 = _0x007f.querySelector(_0xstr(729));
if (_0x0080) {
const _0x0082 = (_0x0080.innerText || _0x0080.textContent || _0xstr(730)).trim().toLowerCase();
if (_0x0082.includes(_0xstr(731)) || _0x0082.includes(_0xstr(732))) {
_0x0041 = _0x007f.querySelector(_0xstr(733));
if (_0x0041) break;
}
}
}
if (!_0x0041) {
const _0x003c = _0x00de.querySelectorAll(_0xstr(734));
for (let _0x006a of _0x003c) {
const ph = _0x006a.placeholder || _0xstr(735);
if (ph.toLowerCase().includes(_0xstr(736)) || ph.toLowerCase().includes(_0xstr(737)) || ph.toLowerCase().includes(_0xstr(738))) {
_0x0041 = _0x006a;
break;
}
}
...
if (_0x0041) {
const _0x00cf = _0x0041.closest(_0xstr(739)) || _0x0041.parentElement;
if (_0x00cf) {
_0x00cf.click();
} else {
_0x0041.removeAttribute(_0xstr(740));
_0x0041.click();
}
log(_0xstr(741));
await _0x0037(2200);
...
if (!_0x000d || _0x000d.tagName !== _0xstr(743) || !_0x00de.contains(_0x000d)) {
_0x000d = _0x0041;
}
_0x000d.removeAttribute(_0xstr(744));
_0x000d.focus();
if (typeof _0x000d.select === _0xstr(745)) _0x000d.select();
_0x000d.value = _0xstr(746);
_0x000d.dispatchEvent(new Event(_0xstr(747), { bubbles: true }));
try {
document.execCommand(_0xstr(748), false, recipientDriver);
} catch (e) {}
...
_0x000d.dispatchEvent(new KeyboardEvent(_0xstr(751), { key: _0xstr(752), bubbles: true }));
_0x000d.dispatchEvent(new KeyboardEvent(_0xstr(753), { key: _0xstr(754), bubbles: true }));
log(_0xstr(755) + recipientDriver + _0xstr(756));
await _0x0037(2500);
const _0x0011 = Array.from(document.querySelectorAll(_0xstr(757)));
...
(el.classList.contains(_0xstr(759)) ||
el.closest(_0xstr(760)) ||
el.closest(_0xstr(761)) ||
el.tagName === _0xstr(762));
});
if (!_0x009c) {
_0x009c = _0x0011.find(el => {
const text = (el.innerText || el.textContent || _0xstr(763)).trim();
return text.includes(recipientDriver) &&
(el.closest(_0xstr(764)) || el.closest(_0xstr(765)) || el.tagName === _0xstr(766));
});
}
if (!_0x009c) {
_0x009c = _0x0011.find(el => {
const text = (el.innerText || el.textContent || _0xstr(767)).trim();
return text.includes(recipientDriver);
});
}
if (_0x009c) {
_0x009c.click();
log(_0xstr(768) + (_0x009c.innerText || _0x009c.textContent).trim());
await _0x0037(1200);
const _0x003b = Array.from(_0x00de.querySelectorAll(_0xstr(769))).find(btn => {
const _0x00eb = btn.innerText || btn.textContent || _0xstr(770);
return _0x00eb.trim() === _0xstr(771) || _0x00eb.trim() === _0xstr(772) || _0x00eb.trim() === _0xstr(773);
});
if (_0x003b) {
_0x003b.click();
log(_0xstr(774));
...
await _0x0037(100);
const _0x0013 = Array.from(document.querySelectorAll(_0xstr(775)));
const _0x0046 = _0x0013.find(el => {
const _0x00eb = (el.innerText || el.textContent || _0xstr(776));
return _0x00eb.includes(_0xstr(777)) || _0x00eb.includes(_0xstr(778));
});
if (_0x0046 && (_0x0046.offsetWidth > 0 || _0x0046.offsetHeight > 0)) {
log(_0xstr(779) + (_0x0046.textContent.trim()) + _0xstr(780));
_0x005d = true;
break;
}
}
if (_0x005d) {
let _0x001c = Array.from(_0x00de.querySelectorAll(_0xstr(781))).find(btn => {
const _0x00eb = (btn.innerText || btn.textContent || _0xstr(782)).trim().toLowerCase();
return _0x00eb === _0xstr(783) || _0x00eb === _0xstr(784) || _0x00eb === _0xstr(785) || _0x00eb === _0xstr(786) || _0x00eb.includes(_0xstr(787)) || _0x00eb.includes(_0xstr(788));
});
if (!_0x001c) {
_0x001c = Array.from(document.querySelectorAll(_0xstr(789))).find(btn => {
const _0x00eb = (btn.innerText || btn.textContent || _0xstr(790)).trim().toLowerCase();
return (_0x00eb === _0xstr(791) || _0x00eb === _0xstr(792) || _0x00eb === _0xstr(793) || _0x00eb === _0xstr(794) || _0x00eb.includes(_0xstr(795)) || _0x00eb.includes(_0xstr(796))) &&
...
const _0x0062 = document.querySelectorAll(_0xstr(834)).length > 0;
return _0x0061 && _0x0062;
}
if (hash.includes(_0xstr(835))) {
const _0x006c = Array.from(document.querySelectorAll(_0xstr(836)));
...
const _0x006c = Array.from(document.querySelectorAll(_0xstr(844)));
...
localStorage.setItem(_0xstr(861), _0x0050);
...
if (_0x00a1 === _0x0050) {
log(_0xstr(866) + (_0x0050) + _0xstr(867));
window.location.reload();
} else {
const _0x001e = _0x000a[_0x0050];
...
const now = Date.now();
if (now - _0x00e9 < 8000) {
const _0x006e = _0x0075 || _0x0077 || _0x0078 || _0x0076;
if (_0x006e) {
log(_0xstr(876));
return;
}
...
_0x00ef();
_0x0022();
_0x0014 = localStorage.getItem(_0xstr(880)) || GM_getValue(_0xstr(881), _0x0000);
...
let _0x00f8 = null;
try {
const _0x0017 = new Blob([_0xstr(905)], { type: _0xstr(906) });
const _0x00f9 = URL.createObjectURL(_0x0017);
