...
const _0x0098 = hash.split(_0xstr(14))[0];
for (const [type, _0x0019] of Object.entries(_0x000a)) {
if (_0x0098.includes(_0x0019.hashKey)) {
return type;
}
}
return null;
}
let _0x00bd = sessionStorage.getItem(_0xstr(15));
if (!_0x00bd) {
_0x00bd = _0xstr(16) + Math.random().toString(36).substring(2, 10) + _0xstr(17) + Date.now();
sessionStorage.setItem(_0xstr(18), _0x00bd);
}
const _0x0059 = _0x004c();
if (_0x0059) {
localStorage.setItem(_0xstr(19) + _0x0059, Date.now().toString());
localStorage.setItem(_0xstr(20) + _0x0059, _0x00bd);
}
function _0x004e() {
const _0x002e = _0x004c();
if (_0x002e) {
const _0x00a9 = localStorage.getItem(_0xstr(21) + _0x002e);
if (_0x00a9 === _0x00bd) {
...
let _0x009b = localStorage.getItem(_0xstr(32)) || GM_getValue(_0xstr(33), _0xstr(34));
...
const _0x00ce = _0xstr(40);
const _0x00c5 = _0xstr(41);
const _0x002b = localStorage.getItem(_0x00ce);
const _0x0084 = parseInt(localStorage.getItem(_0x00c5) || _0xstr(42));
if (!_0x002b || (now - _0x0084) > 5000 || _0x002b === tabType) {
localStorage.setItem(_0x0083, _0xstr(43));
localStorage.setItem(_0x00ce, tabType);
localStorage.setItem(_0x00c5, now.toString());
return true;
}
return false;
}
function _0x00ab(tabType) {
const _0x0083 = _0xstr(44);
const _0x00ce = _0xstr(45);
const _0x00c5 = _0xstr(46);
const _0x002b = localStorage.getItem(_0x00ce);
if (_0x002b === tabType) {
localStorage.removeItem(_0x0083);
localStorage.removeItem(_0x00ce);
localStorage.removeItem(_0x00c5);
_0x007b = Date.now();
}
}
function _0x00cf(tabType) {
const _0x00ce = _0xstr(47);
const _0x00c5 = _0xstr(48);
const _0x002b = localStorage.getItem(_0x00ce);
if (_0x002b === tabType) {
localStorage.setItem(_0x00c5, Date.now().toString());
}
}
GM_registerMenuCommand(_0xstr(49), function() {
let _0x008e = prompt(_0xstr(50), _0x0012);
if (_0x008e) {
_0x0012 = _0x008e.trim();
...
panel.innerHTML = _0xstr(65) + (_0x0012) + _0xstr(66) + (_0x009b) + _0xstr(67);
document.body.appendChild(panel);
const _0x00ca = document.createElement(_0xstr(68));
_0x00ca.innerHTML = _0xstr(69);
document.head.appendChild(_0x00ca);
function _0x001e() {
let _0x0056 = false;
...
const _0x00c8 = document.getElementById(_0xstr(86));
const _0x00d5 = document.getElementById(_0xstr(87));
const _0x0099 = document.getElementById(_0xstr(88));
const _0x00b1 = document.getElementById(_0xstr(89));
const _0x0024 = document.getElementById(_0xstr(90));
const _0x002a = document.getElementById(_0xstr(91));
const _0x00d6 = document.getElementById(_0xstr(92));
const _0x00d4 = document.getElementById(_0xstr(93));
const _0x003a = document.getElementById(_0xstr(94));
const _0x00d7 = document.getElementById(_0xstr(95));
const _0x00bf = document.getElementById(_0xstr(96));
const _0x0093 = document.getElementById(_0xstr(97));
function log(message) {
const _0x00c4 = new Date().toLocaleTimeString();
_0x0085.innerHTML = _0xstr(98) + (_0x00c4) + _0xstr(99) + (message) + _0xstr(100) + _0x0085.innerHTML;
...
_0x00c8.innerText = _0xstr(105);
_0x00c8.style.backgroundColor = _0xstr(106);
} else {
badge.innerText = _0xstr(107);
badge.style.backgroundColor = _0xstr(108);
_0x00c8.innerText = _0xstr(109);
_0x00c8.style.backgroundColor = _0xstr(110);
}
}
function _0x00d3() {
if (_0x0012 && _0x0012 !== _0x0000) {
_0x00d4.style.display = _0xstr(111);
_0x00d6.style.display = _0xstr(112);
_0x00d7.innerText = _0xstr(113);
} else {
_0x00d4.style.display = _0xstr(114);
_0x00d6.style.display = _0xstr(115);
}
}
function _0x00d0() {
const _0x002e = _0x004c();
...
localStorage.setItem(_0xstr(117) + _0x002e, _0x00bd);
}
}
...
function _0x005a(_0x00cb) {
const now = Date.now();
const _0x0042 = localStorage.getItem(_0xstr(151));
if (_0x0042) {
if (_0x00cb === _0xstr(152)) {
log(_0xstr(153));
_0x0023();
} else {
const _0x00b9 = parseInt(localStorage.getItem(_0xstr(154)) || _0xstr(155));
if ((now - _0x00b9) < 300000) {
return;
}
log(_0xstr(156));
_0x0023();
...
if (_0x00c0.length === 0) {
if (_0x00cb === _0xstr(162)) log(_0xstr(163));
return;
}
localStorage.removeItem(_0xstr(164));
log(_0xstr(165) + (_0x00c0.length) + _0xstr(166) + (_0x00c0.map(t => _0x000a[t]?.name || t).join(_0xstr(167))) + _0xstr(168));
localStorage.setItem(_0xstr(169), JSON.stringify(_0x00c0));
localStorage.setItem(_0xstr(170), _0x00c0[0]);
...
let _0x00a4;
try {
_0x00a4 = JSON.parse(localStorage.getItem(_0xstr(188)) || _0xstr(189));
} catch(e) {
_0x0023();
return;
}
_0x00a4.shift();
if (_0x00a4.length > 0) {
const _0x008f = _0x00a4[0];
const _0x0019 = _0x000a[_0x008f];
const now = Date.now();
localStorage.setItem(_0xstr(190), JSON.stringify(_0x00a4));
localStorage.setItem(_0xstr(191), _0x008f);
localStorage.setItem(_0xstr(192), _0xstr(193));
localStorage.setItem(_0xstr(194), now.toString());
localStorage.setItem(_0xstr(195) + _0x008f, now.toString());
...
function _0x004d() {
const _0x00a5 = localStorage.getItem(_0xstr(204));
if (!_0x00a5) return;
let _0x00a4;
try {
_0x00a4 = JSON.parse(_0x00a5);
} catch(e) {
_0x0023();
return;
}
if (!Array.isArray(_0x00a4) || _0x00a4.length === 0) {
_0x0023();
return;
}
const _0x002d = localStorage.getItem(_0xstr(205));
const _0x008c = _0x004c();
if (!_0x008c || _0x008c !== _0x002d) return;
const _0x009c = localStorage.getItem(_0xstr(206));
...
if ((now - _0x00be) > _0x0006) {
const _0x00ae = parseInt(localStorage.getItem(_0xstr(212)) || _0xstr(213));
if (_0x00ae < 1) {
log(_0xstr(214) + (_0x000a[_0x008c]?.name || _0x008c) + _0xstr(215));
localStorage.setItem(_0xstr(216), _0xstr(217));
localStorage.setItem(_0xstr(218), now.toString());
window.location.reload();
} else {
log(_0xstr(219) + (_0x000a[_0x008c]?.name || _0x008c) + _0xstr(220));
...
const _0x0097 = audioCtx.createOscillator();
const _0x004b = audioCtx.createGain();
_0x0097.type = _0xstr(243);
_0x0097.frequency.value = 20000;
_0x004b.gain.value = 0.0001;
_0x0097.connect(_0x004b);
...
_0x0093.addEventListener(_0xstr(253), _0x0094);
_0x00d2();
_0x00d3();
if (_0x006a) {
_0x003c();
...
_0x00d4.style.display = _0xstr(257);
_0x00d6.style.display = _0xstr(258);
_0x00d5.focus();
});
_0x00b1.addEventListener(_0xstr(259), () => {
const _0x005d = _0x00d5.value.trim();
const _0x009a = _0x0099.value.trim() || _0xstr(260);
if (_0x005d && !_0x005d.includes(_0xstr(261))) {
_0x0012 = _0x005d;
_0x009b = _0x009a;
localStorage.setItem(_0xstr(262), _0x0012);
localStorage.setItem(_0xstr(263), _0x009b);
GM_setValue(_0xstr(264), _0x0012);
GM_setValue(_0xstr(265), _0x009b);
log(_0xstr(266) + (_0x009b) + _0xstr(267));
_0x00d3();
alert(_0xstr(268));
} else {
alert(_0xstr(269));
...
_0x00c8.addEventListener(_0xstr(277), _0x00c9);
badge.addEventListener(_0xstr(278), _0x00c9);
_0x0024.addEventListener(_0xstr(279), _0x0027);
launcher.addEventListener(_0xstr(280), _0x0043);
panel.addEventListener(_0xstr(281), _0x00ba);
panel.addEventListener(_0xstr(282), _0x00ba);
panel.addEventListener(_0xstr(283), _0x00ba);
panel.addEventListener(_0xstr(284), _0x00ba);
panel.addEventListener(_0xstr(285), _0x00b5);
function _0x0030(ms) {
...
async function _0x00b4(inputEl, value) {
try {
inputEl.focus();
} catch (e) {}
const _0x008d = Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype, _0xstr(286))?.set;
if (_0x008d) {
_0x008d.call(inputEl, value);
} else {
inputEl.value = value;
}
...
let _0x00c3 = _0xstr(299);
if (method === _0xstr(300)) {
_0x00c3 = _0xstr(301) + (_0x0022) + _0xstr(302) + (urlOrAction) + _0xstr(303) + (encodeURIComponent((_0x009b || _0xstr(304)).trim())) + _0xstr(305);
} else {
_0x00c3 = _0x0022;
}
let isSettled = false;
...
isSettled = true;
clearTimeout(timer);
reject(new Error(_0xstr(313) + (_0x00c3) + _0xstr(314)));
},
ontimeout: function() {
if (isSettled) return;
isSettled = true;
...
options.data = JSON.stringify(Object.assign({ action: urlOrAction, pc: (_0x009b || _0xstr(320)).trim() }, data));
}
...
_0x00cf(_0xstr(338));
const _0x00bc = await _0x0041(_0x0026);
if (_0x00bc) {
_0x007d = Date.now();
...
const _0x00cd = btn.innerText || btn.textContent || _0xstr(355);
return _0x00cd.trim().toLowerCase() === _0xstr(356);
});
...
const _0x00d8 = codes.filter(c => c.startsWith(_0xstr(358)) || c.startsWith(_0xstr(359)) || c.startsWith(_0xstr(360)) || /^[A-Z0-9]{8,25}$/.test(c));
for (let i = 0; i < 40; i++) {
await _0x0030(50);
const _0x000f = Array.from(document.querySelectorAll(_0xstr(361)));
const _0x0049 = _0x000f.find(el => {
const _0x00cd = el.textContent.trim().toUpperCase();
return _0x00d8.some(vc => _0x00cd === vc || _0x00cd.includes(vc));
});
if (_0x0049) {
_0x0062 = true;
}
...
const _0x0081 = _0x0036.split(_0xstr(370)).map(l => l.trim().toUpperCase());
const _0x005f = [];
for (const _0x0080 of _0x0081) {
const _0x0089 = _0x0080.match(/(SPXVN\d+|TETS\d+|VN\d+|[A-Z0-9]{8,25})/g);
if (_0x0089) {
for (const match of _0x0089) {
...
const _0x0090 = Array.from(_0x0032.querySelectorAll(_0xstr(374))).find(btn => {
const _0x00cd = (btn.innerText || btn.textContent || _0xstr(375)).trim().toLowerCase();
return _0x00cd === _0xstr(376) || _0x00cd === _0xstr(377) || _0x00cd === _0xstr(378) || _0x00cd === _0xstr(379) || _0x00cd === _0xstr(380) || _0x00cd.includes(_0xstr(381));
});
if (_0x0090) {
const _0x0091 = 800 + Math.random() * 200;
setTimeout(() => {
_0x0090.click();
log(_0xstr(382));
}, _0x0091);
log(_0xstr(383) + ((_0x0091/1000).toFixed(2)) + _0xstr(384));
}
...
const _0x009d = Array.from(document.querySelectorAll(_0xstr(394))).find(el => {
const _0x00cd = el.innerText || el.textContent || _0xstr(395);
return _0x00cd.trim() === _0xstr(396);
});
if (!_0x009d) return false;
...
const _0x00cd = btn.innerText || btn.textContent || _0xstr(399);
return _0x00cd.trim() === _0xstr(400);
});
if (_0x0035) {
_0x0063 = true;
break;
...
const now = Date.now();
if (now - _0x007c > 2000) {
let _0x00b2 = Array.from(document.querySelectorAll(_0xstr(402))).find(btn => {
...
_0x007e = now;
log(_0xstr(408) + (_0x0082.size) + _0xstr(409));
}
} catch (e) {
...
const _0x00b0 = document.querySelectorAll(_0xstr(425));
for (let _0x00af of _0x00b0) {
const _0x0018 = _0x00af.querySelectorAll(_0xstr(426));
if (_0x0018.length > 0) {
let toNum = _0xstr(427);
let _0x0096 = _0xstr(428);
let _0x00a3 = -1;
if (_0x00c6 !== -1 && _0x0018[_0x00c6]) toNum = _0x0018[_0x00c6].innerText.trim();
if (_0x0092 !== -1 && _0x0018[_0x0092]) _0x0096 = _0x0018[_0x0092].innerText.trim();
if (_0x00a2 !== -1 && _0x0018[_0x00a2]) {
const _0x00a1 = parseInt(_0x0018[_0x00a2].innerText.trim(), 10);
if (!isNaN(_0x00a1)) _0x00a3 = _0x00a1;
}
if (!toNum) {
_0x0018.forEach(c => {
const _0x00cd = c.innerText.trim();
if (/^TO\d+[A-Z0-9]+$/i.test(_0x00cd)) toNum = _0x00cd;
});
}
if (!_0x0096) {
_0x0018.forEach(c => {
const _0x00cd = c.innerText.trim();
if (_0x00cd.includes(_0xstr(429))) _0x0096 = _0x00cd;
});
}
if (_0x00a3 === -1) {
_0x0018.forEach((c, idx) => {
const _0x00cd = c.innerText.trim();
if (/^\d+$/.test(_0x00cd) && idx > 0 && idx !== _0x00c6) {
const _0x00a1 = parseInt(_0x00cd, 10);
if (_0x00a1 > 0) _0x00a3 = _0x00a1;
}
});
}
if (toNum) {
if (!_0x0082.has(toNum.toLowerCase())) {
_0x0082.add(toNum.toLowerCase());
try {
const _0x000e = await _0x0017(_0xstr(430), _0xstr(431), { toNum: toNum });
if (_0x000e.status === _0xstr(432)) {
log(_0xstr(433) + (toNum) + _0xstr(434) + (_0x0096) + _0xstr(435) + (_0x00a3) + _0xstr(436));
_0x007d = Date.now();
} else if (_0x000e.status === _0xstr(437)) {
log(_0xstr(438) + (toNum) + _0xstr(439));
} else {
log(_0xstr(440) + (toNum) + _0xstr(441) + (JSON.stringify(_0x000e)) + _0xstr(442));
}
} catch (err) {
_0x0082.delete(toNum.toLowerCase());
log(_0xstr(443) + (toNum) + _0xstr(444) + (err.message) + _0xstr(445));
}
}
}
}
...
log(_0xstr(446) + (error.message) + _0xstr(447));
} finally {
_0x0068 = false;
}
}
...
if (!hash.includes(_0xstr(448))) return;
if (!_0x000c(_0xstr(449))) {
return;
}
try {
_0x0069 = true;
_0x0078 = Date.now();
_0x00cf(_0xstr(450));
const res = await _0x0017(_0xstr(451), _0xstr(452));
if (res.status === _0xstr(453) && res.toNum) {
const _0x002c = res.toNum;
log(_0xstr(454) + (_0x002c) + _0xstr(455));
await _0x003d();
let _0x00c7 = null;
const _0x0070 = document.querySelectorAll(_0xstr(456));
let _0x00c2 = null;
for (let el of _0x0070) {
const text = el.innerText.trim().toLowerCase();
if (text === _0xstr(457) || text === _0xstr(458) || text === _0xstr(459) || text === _0xstr(460)) {
_0x00c2 = el;
break;
}
}
if (_0x00c2) {
let parent = _0x00c2.parentElement;
for (let i = 0; i < 3 && parent; i++) {
_0x00c7 = parent.querySelector(_0xstr(461));
if (_0x00c7) break;
parent = parent.parentElement;
}
}
if (!_0x00c7) {
const _0x0011 = document.querySelectorAll(_0xstr(462));
for (let input of _0x0011) {
const placeholder = (input.placeholder || _0xstr(463)).toLowerCase();
if (placeholder.includes(_0xstr(464)) || placeholder.includes(_0xstr(465)) || placeholder.includes(_0xstr(466)) || placeholder.includes(_0xstr(467))) {
_0x00c7 = input;
break;
}
}
...
if (!_0x00c7) {
const _0x0011 = Array.from(document.querySelectorAll(_0xstr(468)));
_0x00c7 = _0x0011.find(input => {
const type = (input.type || _0xstr(469)).toLowerCase();
const _0x006c = type === _0xstr(470) || type === _0xstr(471) || type === _0xstr(472);
const _0x006d = input.style.display !== _0xstr(473) && input.style.visibility !== _0xstr(474);
return _0x006c && _0x006d;
});
}
if (_0x00c7) {
log(_0xstr(475) + (_0x002c) + _0xstr(476));
await _0x00b4(_0x00c7, _0x002c);
await _0x0030(100);
_0x00cf(_0xstr(477));
const _0x009e = await _0x00cc(_0x002c);
if (_0x009e) {
log(_0xstr(478) + (_0x002c) + _0xstr(479));
_0x007d = Date.now();
try {
await _0x0017(_0xstr(480), _0xstr(481), { toNum: _0x002c });
log(_0xstr(482) + (_0x002c) + _0xstr(483));
} catch (markErr) {
log(_0xstr(484) + (_0x002c) + _0xstr(485) + (markErr.message) + _0xstr(486));
}
} else {
log(_0xstr(487) + (_0x002c) + _0xstr(488));
}
} else {
log(_0xstr(489));
}
...
log(_0xstr(490) + (error.message) + _0xstr(491));
} finally {
_0x0069 = false;
_0x00ab(_0xstr(492));
}
}
function _0x00cc(_0x002c) {
return new Promise((resolve) => {
let _0x001d = 0;
let _0x0020 = setInterval(() => {
_0x001d++;
let _0x009d = null;
const _0x0016 = document.querySelectorAll(_0xstr(493));
for (let btn of _0x0016) {
const text = btn.innerText.trim();
if (text === _0xstr(494) || text === _0xstr(495) || text === _0xstr(496) || text.includes(_0xstr(497))) {
_0x009d = btn;
break;
}
}
if (!_0x009d) {
const _0x003b = document.querySelectorAll(_0xstr(498));
for (let el of _0x003b) {
const text = el.innerText.trim();
if (text === _0xstr(499) || text === _0xstr(500) || text === _0xstr(501) || text.includes(_0xstr(502))) {
_0x009d = el.closest(_0xstr(503)) || el;
break;
}
}
}
if (_0x009d && !_0x009d.disabled && !_0x009d.classList.contains(_0xstr(504))) {
clearInterval(_0x0020);
log(_0xstr(505));
_0x009d.click();
setTimeout(() => {
log(_0xstr(506) + (_0x002c) + _0xstr(507));
resolve(true);
}, 800);
} else if (_0x001d > 20) {
clearInterval(_0x0020);
...
const hash = window.location.hash || _0xstr(508);
if (!hash.includes(_0xstr(509))) return;
if (!_0x000c(_0xstr(510))) {
return;
}
try {
_0x0067 = true;
_0x0073 = Date.now();
_0x00cf(_0xstr(511));
const data = await _0x0017(_0xstr(512), _0xstr(513));
if (data.status === _0xstr(514)) {
const pupCode = data.pupCode;
const _0x00a6 = data.recipientDriver;
const recipientDriver = _0x0044(_0x00a6);
const now = Date.now();
if (pupCode === _0x0072 && (now - _0x0074) < 30000) {
log(_0xstr(515) + (pupCode) + _0xstr(516));
_0x0067 = false;
_0x00ab(_0xstr(517));
return;
}
log(_0xstr(518) + (pupCode) + _0xstr(519) + (recipientDriver) + _0xstr(520) + (_0x00a6) + _0xstr(521));
_0x00cf(_0xstr(522));
const _0x00bc = await _0x0040(pupCode, recipientDriver);
if (_0x00bc) {
_0x0072 = pupCode;
_0x0074 = Date.now();
log(_0xstr(523) + (pupCode) + _0xstr(524) + (recipientDriver) + _0xstr(525));
try {
await _0x0017(_0xstr(526), _0xstr(527), { pupCode: pupCode, status: _0xstr(528) });
log(_0xstr(529) + (pupCode) + _0xstr(530));
} catch (err) {
log(_0xstr(531) + (pupCode) + _0xstr(532) + (err.message) + _0xstr(533));
}
} else {
log(_0xstr(534));
try {
await _0x0017(_0xstr(535), _0xstr(536), { pupCode: pupCode, status: _0xstr(537) });
log(_0xstr(538) + (pupCode) + _0xstr(539));
} catch (err) {
log(_0xstr(540) + (pupCode) + _0xstr(541) + (err.message) + _0xstr(542));
}
}
}
} catch (error) {
log(_0xstr(543) + (error.message) + _0xstr(544));
} finally {
_0x0067 = false;
_0x00ab(_0xstr(545));
}
...
const _0x006f = _0x006e.querySelector(_0xstr(547));
if (_0x006f) {
const _0x0071 = (_0x006f.innerText || _0x006f.textContent || _0xstr(548)).trim().toLowerCase();
if (_0x0071.includes(_0xstr(549)) || _0x0071.includes(_0xstr(550)) || _0x0071 === _0xstr(551)) {
_0x0046 = _0x006e.querySelector(_0xstr(552));
if (_0x0046) break;
}
}
}
if (!_0x0046) {
const _0x0011 = document.querySelectorAll(_0xstr(553));
for (let input of _0x0011) {
const placeholder = input.placeholder || _0xstr(554);
if (placeholder.toLowerCase().includes(_0xstr(555)) || placeholder.toLowerCase().includes(_0xstr(556))) {
_0x0046 = input;
break;
}
}
...
await _0x00b4(_0x0046, pupCode);
await _0x0030(300);
let _0x00b2 = Array.from(document.querySelectorAll(_0xstr(558))).find(btn => {
const _0x00cd = btn.innerText || btn.textContent || _0xstr(559);
return _0x00cd.trim() === _0xstr(560) || _0x00cd.trim() === _0xstr(561);
});
if (_0x00b2) {
_0x00b2.click();
log(_0xstr(562) + pupCode);
} else {
_0x0046.dispatchEvent(new KeyboardEvent(_0xstr(563), { key: _0xstr(564), code: _0xstr(565), keyCode: 13, which: 13, bubbles: true }));
}
await _0x0030(2000);
_0x00cf(_0xstr(566));
const _0x00b0 = Array.from(document.querySelectorAll(_0xstr(567)));
let _0x00a8 = false;
for (let _0x00af of _0x00b0) {
const _0x00a7 = Array.from(_0x00af.querySelectorAll(_0xstr(568))).find(el => {
const _0x00cd = el.innerText || el.textContent || _0xstr(569);
return _0x00cd.trim() === _0xstr(570) || _0x00cd.trim() === _0xstr(571) || _0x00cd.trim() === _0xstr(572);
});
if (_0x00a7) {
log(_0xstr(573));
_0x00a7.click();
await _0x0030(2500);
_0x00cf(_0xstr(574));
const _0x0037 = document.querySelectorAll(_0xstr(575));
let _0x00c1 = null;
for (const _0x0032 of _0x0037) {
if (_0x0032.offsetWidth > 0 || _0x0032.offsetHeight > 0) {
const text = (_0x0032.innerText || _0x0032.textContent || _0xstr(576));
if (text.includes(_0xstr(577)) || text.includes(_0xstr(578)) || text.includes(_0xstr(579)) || text.includes(_0xstr(580))) {
_0x00c1 = _0x0032;
break;
}
}
...
if (_0x00c1) {
let _0x0039 = null;
const _0x0048 = _0x00c1.querySelectorAll(_0xstr(581));
for (let _0x006e of _0x0048) {
const _0x006f = _0x006e.querySelector(_0xstr(582));
if (_0x006f) {
const _0x0071 = (_0x006f.innerText || _0x006f.textContent || _0xstr(583)).trim().toLowerCase();
if (_0x0071.includes(_0xstr(584)) || _0x0071.includes(_0xstr(585))) {
_0x0039 = _0x006e.querySelector(_0xstr(586));
if (_0x0039) break;
}
}
}
if (!_0x0039) {
const _0x0034 = _0x00c1.querySelectorAll(_0xstr(587));
for (let _0x005c of _0x0034) {
const ph = _0x005c.placeholder || _0xstr(588);
if (ph.toLowerCase().includes(_0xstr(589)) || ph.toLowerCase().includes(_0xstr(590)) || ph.toLowerCase().includes(_0xstr(591))) {
_0x0039 = _0x005c;
break;
}
}
...
if (_0x0039) {
const _0x00b3 = _0x0039.closest(_0xstr(592)) || _0x0039.parentElement;
if (_0x00b3) {
_0x00b3.click();
} else {
_0x0039.removeAttribute(_0xstr(593));
_0x0039.click();
}
log(_0xstr(594));
await _0x0030(2200);
...
if (!_0x000d || _0x000d.tagName !== _0xstr(596) || !_0x00c1.contains(_0x000d)) {
_0x000d = _0x0039;
}
_0x000d.removeAttribute(_0xstr(597));
_0x000d.focus();
if (typeof _0x000d.select === _0xstr(598)) _0x000d.select();
_0x000d.value = _0xstr(599);
_0x000d.dispatchEvent(new Event(_0xstr(600), { bubbles: true }));
try {
document.execCommand(_0xstr(601), false, recipientDriver);
} catch (e) {}
if (_0x000d.value !== recipientDriver) {
_0x000d.value = recipientDriver;
}
_0x000d.dispatchEvent(new Event(_0xstr(602), { bubbles: true }));
...
_0x000d.dispatchEvent(new KeyboardEvent(_0xstr(606), { key: _0xstr(607), bubbles: true }));
log(_0xstr(608) + recipientDriver + _0xstr(609));
await _0x0030(2500);
const _0x0010 = Array.from(document.querySelectorAll(_0xstr(610)));
let _0x0088 = _0x0010.find(el => {
const text = (el.innerText || el.textContent || _0xstr(611)).trim();
return text.includes(recipientDriver) &&
(el.offsetWidth > 0 || el.offsetHeight > 0) &&
(el.classList.contains(_0xstr(612)) ||
el.closest(_0xstr(613)) ||
el.closest(_0xstr(614)) ||
el.tagName === _0xstr(615));
});
if (!_0x0088) {
_0x0088 = _0x0010.find(el => {
const text = (el.innerText || el.textContent || _0xstr(616)).trim();
return text.includes(recipientDriver) &&
(el.closest(_0xstr(617)) || el.closest(_0xstr(618)) || el.tagName === _0xstr(619));
});
}
if (!_0x0088) {
_0x0088 = _0x0010.find(el => {
const text = (el.innerText || el.textContent || _0xstr(620)).trim();
return text.includes(recipientDriver);
});
}
if (_0x0088) {
_0x0088.click();
log(_0xstr(621) + (_0x0088.innerText || _0x0088.textContent).trim());
await _0x0030(1200);
const _0x0033 = Array.from(_0x00c1.querySelectorAll(_0xstr(622))).find(btn => {
const _0x00cd = btn.innerText || btn.textContent || _0xstr(623);
return _0x00cd.trim() === _0xstr(624) || _0x00cd.trim() === _0xstr(625) || _0x00cd.trim() === _0xstr(626);
});
if (_0x0033) {
_0x0033.click();
log(_0xstr(627));
...
log(_0xstr(629) + recipientDriver);
}
} else {
log(_0xstr(630));
}
...
function _0x001a() {
const now = Date.now();
if (_0x0066 && _0x0079 > 0 && (now - _0x0079) > _0x0009) {
log(_0xstr(632));
_0x0066 = false;
_0x00ab(_0xstr(633));
_0x0079 = 0;
}
if (_0x0068 && _0x0075 > 0 && (now - _0x0075) > _0x0009) {
log(_0xstr(634));
_0x0068 = false;
_0x00ab(_0xstr(635));
_0x0075 = 0;
}
if (_0x0069 && _0x0078 > 0 && (now - _0x0078) > _0x0009) {
log(_0xstr(636));
_0x0069 = false;
_0x00ab(_0xstr(637));
_0x0078 = 0;
}
if (_0x0067 && _0x0073 > 0 && (now - _0x0073) > _0x0009) {
log(_0xstr(638));
_0x0067 = false;
_0x00ab(_0xstr(639));
_0x0073 = 0;
...
if (href.includes(_0xstr(640)) || href.includes(_0xstr(641))) {
log(_0xstr(642));
window.location.reload();
return false;
}
...
function _0x0064() {
const hash = window.location.hash || _0xstr(643);
const href = window.location.href;
if (href.includes(_0xstr(644)) || href.includes(_0xstr(645))) return false;
const _0x0087 = document.querySelectorAll(_0xstr(646));
for (const _0x0086 of _0x0087) {
if (_0x0086.offsetWidth > 100 && _0x0086.offsetHeight > 100) {
const style = window.getComputedStyle(_0x0086);
if (style.display !== _0xstr(647) && style.visibility !== _0xstr(648) && style.opacity !== _0xstr(649)) {
return false;
}
}
}
if (hash.includes(_0xstr(650))) {
const textarea = document.querySelector(_0xstr(651)) || document.querySelector(_0xstr(652));
if (!textarea) return false;
const style = window.getComputedStyle(textarea);
return textarea.offsetWidth > 0 && style.display !== _0xstr(653) && style.visibility !== _0xstr(654);
}
if (hash.includes(_0xstr(655))) {
const _0x0016 = Array.from(document.querySelectorAll(_0xstr(656)));
const _0x0054 = _0x0016.some(btn => {
const text = (btn.innerText || btn.textContent || _0xstr(657)).trim().toLowerCase();
const style = window.getComputedStyle(btn);
const _0x006d = btn.offsetWidth > 0 && style.display !== _0xstr(658) && style.visibility !== _0xstr(659);
return _0x006d && (text.includes(_0xstr(660)) || text.includes(_0xstr(661)));
});
const _0x0055 = document.querySelectorAll(_0xstr(662)).length > 0;
return _0x0054 && _0x0055;
}
if (hash.includes(_0xstr(663))) {
const _0x005e = Array.from(document.querySelectorAll(_0xstr(664)));
const _0x0057 = _0x005e.some(input => {
const type = (input.type || _0xstr(665)).toLowerCase();
const style = window.getComputedStyle(input);
const _0x006c = type === _0xstr(666) || type === _0xstr(667) || type === _0xstr(668);
return _0x006c && input.offsetWidth > 0 && style.display !== _0xstr(669) && style.visibility !== _0xstr(670);
});
return _0x0057;
}
if (hash.includes(_0xstr(671))) {
const _0x005e = Array.from(document.querySelectorAll(_0xstr(672)));
const _0x0053 = _0x005e.some(input => {
const style = window.getComputedStyle(input);
return input.offsetWidth > 0 && style.display !== _0xstr(673) && style.visibility !== _0xstr(674);
});
const _0x0016 = Array.from(document.querySelectorAll(_0xstr(675)));
const _0x004f = _0x0016.some(btn => {
const style = window.getComputedStyle(btn);
return btn.offsetWidth > 0 && style.display !== _0xstr(676) && style.visibility !== _0xstr(677);
});
...
log(_0xstr(678));
for (const type of _0x0002) {
localStorage.setItem(_0xstr(679) + type, _0xstr(680));
}
setTimeout(() => {
log(_0xstr(681));
_0x005a(_0xstr(682));
...
const _0x008c = _0x004c();
if (_0x008c) {
const _0x00cb = localStorage.getItem(_0xstr(683) + _0x008c);
if (_0x00cb === _0xstr(684)) {
localStorage.removeItem(_0xstr(685) + _0x008c);
log(_0xstr(686));
localStorage.setItem(_0xstr(687) + _0x008c, _0xstr(688));
localStorage.removeItem(_0xstr(689) + _0x008c);
window.close();
}
}
}
function _0x001f() {
const now = Date.now();
if (localStorage.getItem(_0xstr(690)) || localStorage.getItem(_0xstr(691))) return;
const _0x0061 = !_0x0066 && !_0x0068 && !_0x0069 && !_0x0067;
if (_0x0061 && (now - _0x007d) > _0x0001) {
_0x005b();
}
}
let _0x008b = 0;
...
_0x00d1();
_0x001c();
_0x0012 = localStorage.getItem(_0xstr(692)) || GM_getValue(_0xstr(693), _0x0000);
_0x009b = localStorage.getItem(_0xstr(694)) || GM_getValue(_0xstr(695), _0xstr(696));
_0x006a = localStorage.getItem(_0xstr(697)) === _0xstr(698);
_0x00d2();
const _0x002f = window.location.href;
const hash = window.location.hash || _0xstr(699);
if (_0x002f !== _0x007f) {
_0x007f = _0x002f;
_0x0068 = false;
_0x0069 = false;
...
let _0x00d9 = null;
try {
const _0x0015 = new Blob([_0xstr(704)], { type: _0xstr(705) });
const _0x00da = URL.createObjectURL(_0x0015);
_0x00d9 = new Worker(_0x00da);
_0x00d9.onmessage = function(e) {
if (e.data === _0xstr(706)) {
_0x008a();
}
};
log(_0xstr(707));
...
if (document.readyState === _0xstr(709)) {
document.addEventListener(_0xstr(710), init);
} else {
init();
}
})();
