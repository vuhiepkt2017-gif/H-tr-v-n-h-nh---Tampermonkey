...
<_0x006f style="display: block; margin-bottom: 4px; color: #aaa;">Link Google Web App:</_0x006f>
...
<_0x006f style="display: block; margin-bottom: 4px; color: #aaa;">Tên Máy Tính (PC Name):</_0x006f>
<input type="text" id="ap-pc-input" style="width: 93%; padding: 6px; border-radius: 4px; border: 1px solid #555; background-color: #2a2a35; color: white; font-size: 11px;" value="${_0x0099}">
</div>
...
<_0x006f style="display: block; margin-bottom: 6px; color: #ff9800; font-weight: bold;">Trạng thái các Tab (Auto-Open):</_0x006f>
...
const _0x00ca = document.createElement(_0xstr(65));
_0x00ca.innerHTML = `
...
function _0x001e() {
let _0x0055 = false;
const _0x0037 = document.querySelectorAll(_0xstr(66));
...
const _0x0085 = document.getElementById(_0xstr(80));
const badge = document.getElementById(_0xstr(81));
const _0x00c8 = document.getElementById(_0xstr(82));
const _0x00d5 = document.getElementById(_0xstr(83));
const _0x0097 = document.getElementById(_0xstr(84));
const _0x00af = document.getElementById(_0xstr(85));
const _0x0024 = document.getElementById(_0xstr(86));
const _0x002a = document.getElementById(_0xstr(87));
const _0x00d6 = document.getElementById(_0xstr(88));
const _0x00d4 = document.getElementById(_0xstr(89));
const _0x003a = document.getElementById(_0xstr(90));
const _0x00d7 = document.getElementById(_0xstr(91));
const _0x00be = document.getElementById(_0xstr(92));
const _0x0091 = document.getElementById(_0xstr(93));
function log(message) {
const _0x00c4 = new Date().toLocaleTimeString();
_0x0085.innerHTML = `[${_0x00c4}] ${message}<br>` + _0x0085.innerHTML;
const _0x0081 = _0x0085.innerHTML.split(_0xstr(94));
if (_0x0081.length > 20) _0x0085.innerHTML = _0x0081.slice(0, 20).join(_0xstr(95));
}
function _0x00d2() {
if (_0x0069) {
badge.innerText = _0xstr(96);
badge.style.backgroundColor = _0xstr(97);
_0x00c8.innerText = _0xstr(98);
_0x00c8.style.backgroundColor = _0xstr(99);
} else {
badge.innerText = _0xstr(100);
badge.style.backgroundColor = _0xstr(101);
_0x00c8.innerText = _0xstr(102);
_0x00c8.style.backgroundColor = _0xstr(103);
}
}
function _0x00d3() {
if (_0x0012 && _0x0012 !== _0x0000) {
_0x00d4.style.display = _0xstr(104);
_0x00d6.style.display = _0xstr(105);
_0x00d7.innerText = _0xstr(106);
} else {
_0x00d4.style.display = _0xstr(107);
_0x00d6.style.display = _0xstr(108);
}
}
function _0x00d0() {
const _0x002e = _0x004b();
if (_0x002e) {
localStorage.setItem(_0xstr(109) + _0x002e, Date.now().toString());
localStorage.setItem(_0xstr(110) + _0x002e, _0x00bc);
}
}
...
function _0x00d1() {
_0x00be.innerHTML = _0xstr(111);
const now = Date.now();
for (const [type, _0x0019] of Object.entries(_0x000a)) {
const _0x007a = parseInt(localStorage.getItem(_0xstr(112) + type) || _0xstr(113));
const _0x006b = _0x007a > 0 && (now - _0x007a) < _0x000b;
const _0x006e = document.createElement(_0xstr(114));
_0x006e.style = `display: flex; align-items: center; justify-content: space-between; padding: 4px 6px; border-radius: 4px; background-color: ${_0x006b ? 'rgba(76, 175, 80, 0.15)' : 'rgba(244, 67, 54, 0.15)'}; border: 1px solid ${_0x006b ? '#4caf50' : '#f44336'}; font-size: 11px;`;
_0x006e.innerHTML = `
<span style="font-weight: bold; color: ${_0x006b ? '#81c784' : '#e57373'};">${_0x0019.name}</span>
<span style="font-size: 9px; padding: 1px 4px; border-radius: 3px; background-color: ${_0x006b ? '#4caf50' : '#f44336'}; color: white;">
${_0x006b ? 'Mở' : 'Tắt'}
</span>
`;
_0x006e.style.cursor = _0xstr(115);
_0x006e.title = `Bấm để mở tab ${_0x0019.name}`;
_0x006e.addEventListener(_0xstr(116), () => {
if (typeof GM_openInTab !== _0xstr(117)) {
GM_openInTab(_0x0019.url, { active: true, insert: true, setParent: true });
} else {
window.open(_0x0019.url, _0xstr(118));
}
});
...
function _0x0059(_0x00cb) {
const now = Date.now();
const _0x0041 = localStorage.getItem(_0xstr(124));
if (_0x0041) {
if (_0x00cb === _0xstr(125)) {
log(_0xstr(126));
_0x0023();
} else {
const _0x00b8 = parseInt(localStorage.getItem(_0xstr(127)) || _0xstr(128));
...
if (_0x00cb === _0xstr(130)) {
localStorage.setItem(_0xstr(131) + type, _0xstr(132));
_0x00bf.push(type);
} else {
const _0x007a = parseInt(localStorage.getItem(_0xstr(133) + type) || _0xstr(134));
...
if (_0x00bf.length === 0) {
if (_0x00cb === _0xstr(135)) log(_0xstr(136));
return;
}
localStorage.removeItem(_0xstr(137));
log(`[Mở Tab] ▶ Bắt đầu mở tuần tự ${_0x00bf.length} tab: ${_0x00bf.map(t => _0x000a[t]?.name || t).join(' → ')}`);
localStorage.setItem(_0xstr(138), JSON.stringify(_0x00bf));
localStorage.setItem(_0xstr(139), _0x00bf[0]);
...
localStorage.setItem(_0xstr(144) + _0x0046, now.toString());
const _0x008a = _0x004b();
if (_0x008a === _0x0046) {
log(`[Mở Tab] 🔄 Đang ở tab đầu tiên (${_0x0019.name}) - tiến hành reload...`);
window.location.reload();
} else {
log(`[Mở Tab] 🔄 Đang mở tab: ${_0x0019.name}...`);
if (typeof GM_openInTab !== _0xstr(145)) {
GM_openInTab(_0x0019.url, { active: true, insert: true, setParent: true });
} else {
window.open(_0x0019.url, _0xstr(146));
}
}
}
function _0x0023() {
...
let _0x00a2;
try {
_0x00a2 = JSON.parse(localStorage.getItem(_0xstr(153)) || _0xstr(154));
} catch(e) {
_0x0023();
return;
}
...
const now = Date.now();
localStorage.setItem(_0xstr(155), JSON.stringify(_0x00a2));
localStorage.setItem(_0xstr(156), _0x008d);
localStorage.setItem(_0xstr(157), _0xstr(158));
localStorage.setItem(_0xstr(159), now.toString());
localStorage.setItem(_0xstr(160) + _0x008d, now.toString());
localStorage.removeItem(_0xstr(161));
const _0x008a = _0x004b();
if (_0x008a === _0x008d) {
log(`[Mở Tab] 🔄 Đang ở tab tiếp theo (${_0x0019.name}) - tiến hành reload...`);
window.location.reload();
} else {
log(`[Mở Tab] ➡ Mở tab tiếp: ${_0x0019.name}...`);
if (typeof GM_openInTab !== _0xstr(162)) {
GM_openInTab(_0x0019.url, { active: true, insert: true, setParent: true });
} else {
window.open(_0x0019.url, _0xstr(163));
}
}
} else {
_0x0023();
...
function _0x004c() {
const _0x00a3 = localStorage.getItem(_0xstr(165));
if (!_0x00a3) return;
let _0x00a2;
try {
...
const _0x002d = localStorage.getItem(_0xstr(166));
const _0x008a = _0x004b();
if (!_0x008a || _0x008a !== _0x002d) return;
const _0x009a = localStorage.getItem(_0xstr(167));
if (_0x009a !== _0xstr(168)) return;
const _0x00bd = parseInt(localStorage.getItem(_0xstr(169)) || _0xstr(170));
const now = Date.now();
if (_0x0063()) {
log(`[Mở Tab] ✓ Tab ${_0x000a[_0x008a]?.name || _0x008a} đã load đầy đủ và sẵn sàng!`);
_0x007d = Date.now();
_0x0093();
return;
}
if ((now - _0x00bd) > _0x0006) {
const _0x00ac = parseInt(localStorage.getItem(_0xstr(171)) || _0xstr(172));
if (_0x00ac < 1) {
log(`[Mở Tab] ⚠ Tab ${_0x000a[_0x008a]?.name || _0x008a} load quá 45s. Thử reload lại...`);
localStorage.setItem(_0xstr(173), _0xstr(174));
localStorage.setItem(_0xstr(175), now.toString());
window.location.reload();
} else {
log(`[Mở Tab] ✗ Tab ${_0x000a[_0x008a]?.name || _0x008a} không thể load. Bỏ qua...`);
...
let _0x004f = false;
let _0x0051 = false;
let _0x0049 = _0xstr(179);
for (const [type, _0x0019] of Object.entries(_0x000a)) {
const _0x007a = parseInt(localStorage.getItem(_0xstr(180) + type) || _0xstr(181));
const _0x00a8 = localStorage.getItem(_0xstr(182) + type);
const _0x006b = _0x007a > 0 && (now - _0x007a) < _0x000b;
if (!_0x006b) {
const _0x0076 = parseInt(localStorage.getItem(_0xstr(183) + type) || _0xstr(184));
...
log(`[Hệ thống] Phát hiện tab ${_0x0019.name} bị đóng băng. Đang kích hoạt (Unfreeze) lại tab...`);
localStorage.setItem(_0xstr(185) + _0x0049, now.toString());
if (typeof GM_openInTab !== _0xstr(186)) {
GM_openInTab(_0x0019.url, { active: true, insert: true, setParent: true });
} else {
window.open(_0x0019.url, _0xstr(187));
}
return;
}
if (_0x004f) {
...
function _0x001b() {
if (audioCtx && audioCtx.state === _0xstr(199)) {
audioCtx.resume().then(() => {
log(_0xstr(200));
}).catch(() => {});
}
if (audioCtx && audioCtx.state === _0xstr(201)) {
audioCtx = null;
_0x00b7();
log(_0xstr(202));
}
...
if (document.visibilityState === _0xstr(205) && _0x0069) {
_0x00ab();
}
});
_0x0091.addEventListener(_0xstr(206), _0x0092);
_0x00d2();
_0x00d3();
if (_0x0069) {
_0x003c();
const _0x0057 = () => {
if (_0x0069) _0x003c();
document.removeEventListener(_0xstr(207), _0x0057);
};
document.addEventListener(_0xstr(208), _0x0057);
}
_0x003a.addEventListener(_0xstr(209), () => {
_0x00d4.style.display = _0xstr(210);
_0x00d6.style.display = _0xstr(211);
_0x00d5.focus();
});
_0x00af.addEventListener(_0xstr(212), () => {
const _0x005c = _0x00d5.value.trim();
const _0x0098 = _0x0097.value.trim() || _0xstr(213);
if (_0x005c && !_0x005c.includes(_0xstr(214))) {
_0x0012 = _0x005c;
_0x0099 = _0x0098;
localStorage.setItem(_0xstr(215), _0x0012);
localStorage.setItem(_0xstr(216), _0x0099);
GM_setValue(_0xstr(217), _0x0012);
GM_setValue(_0xstr(218), _0x0099);
log(`Đã lưu cấu hình. PC: ${_0x0099}`);
_0x00d3();
alert(_0xstr(219));
} else {
alert(_0xstr(220));
...
_0x0069 = !_0x0069;
localStorage.setItem(_0xstr(223), _0x0069 ? [_0xstr(224)] : _0xstr(225));
_0x00d2();
log(_0x0069 ? [_0xstr(226)] : _0xstr(227));
if (_0x0069) {
_0x003c();
_0x0092();
} else {
...
_0x00c8.addEventListener(_0xstr(228), _0x00c9);
badge.addEventListener(_0xstr(229), _0x00c9);
_0x0024.addEventListener(_0xstr(230), _0x0027);
launcher.addEventListener(_0xstr(231), _0x0042);
panel.addEventListener(_0xstr(232), _0x00b9);
panel.addEventListener(_0xstr(233), _0x00b9);
panel.addEventListener(_0xstr(234), _0x00b9);
panel.addEventListener(_0xstr(235), _0x00b9);
panel.addEventListener(_0xstr(236), _0x00b4);
function _0x0030(ms) {
...
const _0x008b = Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype, _0xstr(237))?.set;
if (_0x008b) {
...
let _0x0022 = (_0x0012 || _0xstr(247)).trim();
if (!_0x0022 || _0x0022.includes(_0xstr(248))) {
reject(new Error(_0xstr(249)));
return;
}
let _0x00c2 = _0xstr(250);
if (method === _0xstr(251)) {
_0x00c2 = `${_0x0022}?action=${urlOrAction}&pc=${encodeURIComponent((_0x0099 || "").trim())}`;
} else {
_0x00c2 = _0x0022;
}
let isSettled = false;
...
isSettled = true;
clearTimeout(timer);
reject(new Error(`Lỗi kết nối mạng đến ${_0x00c2}`));
},
ontimeout: function() {
if (isSettled) return;
isSettled = true;
...
options.data = JSON.stringify(Object.assign({ action: urlOrAction, pc: (_0x0099 || _0xstr(255)).trim() }, data));
}
...
_0x0079 = Date.now();
_0x00cf(_0xstr(260));
const data = await _0x0017(_0xstr(261), _0xstr(262));
_0x007d = Date.now();
if (data.status === _0xstr(263)) {
let _0x0026 = [];
if (data.code) {
_0x0026 = data.code.split(_0xstr(264)).map(c => c.trim().toUpperCase()).filter(c => c.length > 0);
} else if (data.codes && Array.isArray(data.codes)) {
_0x0026 = data.codes.map(c => c.trim().toUpperCase());
}
if (_0x0026.length > 0) {
log(`Tìm thấy lô gồm ${_0x0026.length} mã để in.`);
_0x00cf(_0xstr(265));
const _0x00bb = await _0x0040(_0x0026);
if (_0x00bb) {
_0x007d = Date.now();
log(`Đã in lô thành công: ${_0x0026.join(', ')}`);
} else {
...
const _0x0028 = codes.join(_0xstr(270));
...
textarea.focus();
textarea.select();
document.execCommand(_0xstr(273), false, _0x0028);
textarea.dispatchEvent(new Event(_0xstr(274), { bubbles: true }));
} catch (e) {}
await _0x0031(300, 500);
const _0x0029 = Array.from(document.querySelectorAll(_0xstr(275))).find(btn => {
const _0x00cd = btn.innerText || btn.textContent || _0xstr(276);
return _0x00cd.trim().toLowerCase() === _0xstr(277);
});
if (!_0x0029) return false;
_0x0029.click();
let _0x0061 = false;
let _0x0050 = false;
let _0x003e = _0xstr(278);
const _0x00d8 = codes.filter(c => c.startsWith(_0xstr(279)) || c.startsWith(_0xstr(280)) || c.startsWith(_0xstr(281)) || /^[A-Z0-9]{8,25}$/.test(c));
for (let i = 0; i < 40; i++) {
await _0x0030(50);
...
const _0x0037 = document.querySelectorAll(_0xstr(283));
for (const _0x0032 of _0x0037) {
if (_0x0032.offsetWidth > 0 || _0x0032.offsetHeight > 0) {
const _0x0036 = (_0x0032.innerText || _0x0032.textContent || _0xstr(284));
if (_0x0036.toLowerCase().includes(_0xstr(285)) ||
_0x0036.toLowerCase().includes(_0xstr(286)) ||
_0x0036.toLowerCase().includes(_0xstr(287)) ||
_0x0036.toLowerCase().includes(_0xstr(288)) ||
_0x0036.toLowerCase().includes(_0xstr(289))) {
_0x0050 = true;
_0x003e = _0x0036.trim().replace(/\n/g, _0xstr(290));
const _0x0081 = _0x0036.split(_0xstr(291)).map(l => l.trim().toUpperCase());
const _0x005e = [];
...
const _0x008e = Array.from(_0x0032.querySelectorAll(_0xstr(295))).find(btn => {
const _0x00cd = (btn.innerText || btn.textContent || _0xstr(296)).trim().toLowerCase();
return _0x00cd === _0xstr(297) || _0x00cd === _0xstr(298) || _0x00cd === _0xstr(299) || _0x00cd === _0xstr(300) || _0x00cd === _0xstr(301) || _0x00cd.includes(_0xstr(302));
});
if (_0x008e) {
...
log(`[In Bill] Phát hiện _0x0032 lỗi. Đợi ${(_0x008f/1000).toFixed(2)} giây để tự động đóng...`);
}
for (const _0x003d of _0x0025) {
_0x0017(_0xstr(303), _0xstr(304), { code: _0x003d, status: _0xstr(305) })
.then(() => {
log(`[In Bill] Đã báo cáo thành công mã lỗi: '${_0x003d}' = 'Mã lỗi'.`);
})
.catch(e => {
log(`[In Bill] Gặp lỗi khi gửi báo cáo cho ${_0x003d}: ${e.message}`);
});
}
break;
}
...
const _0x009b = Array.from(document.querySelectorAll(_0xstr(307))).find(el => {
const _0x00cd = el.innerText || el.textContent || _0xstr(308);
return _0x00cd.trim() === _0xstr(309);
});
...
for (let i = 0; i < 20; i++) {
await _0x0030(50);
const _0x0037 = document.querySelectorAll(_0xstr(310));
for (const _0x0032 of _0x0037) {
if (_0x0032.offsetWidth > 0 || _0x0032.offsetHeight > 0) {
_0x0035 = Array.from(_0x0032.querySelectorAll(_0xstr(311))).find(btn => {
const _0x00cd = btn.innerText || btn.textContent || _0xstr(312);
return _0x00cd.trim() === _0xstr(313);
});
if (_0x0035) {
_0x0062 = true;
break;
...
const now = Date.now();
if (now - _0x007c > 2000) {
let _0x00b0 = Array.from(document.querySelectorAll(_0xstr(315))).find(btn => {
...
try {
const res = await _0x0017(_0xstr(318), _0xstr(319));
if (res.status === _0xstr(320) && Array.isArray(res.data)) {
_0x0082 = new Set(res.data.map(to => to.toLowerCase()));
_0x007e = now;
log(`[TO Quét] Đã đồng bộ ${_0x0082.size} mã TO đã tồn tại từ Excel.`);
}
} catch (e) {
...
const _0x00ae = document.querySelectorAll(_0xstr(334));
for (let _0x00ad of _0x00ae) {
const _0x0018 = _0x00ad.querySelectorAll(_0xstr(335));
if (_0x0018.length > 0) {
let toNum = _0xstr(336);
let _0x0094 = _0xstr(337);
let _0x00a1 = -1;
...
_0x0018.forEach(c => {
const _0x00cd = c.innerText.trim();
if (_0x00cd.includes(_0xstr(338))) _0x0094 = _0x00cd;
});
}
if (_0x00a1 === -1) {
...
const _0x009f = parseInt(_0x00cd, 10);
if (_0x009f > 0) _0x00a1 = _0x009f;
}
});
}
if (toNum && _0x0094 && _0x00a1 > 0) {
const _0x006a = _0x0094.toLowerCase() === _0xstr(339);
if (!_0x006a && !_0x0082.has(toNum.toLowerCase())) {
_0x0082.add(toNum.toLowerCase());
try {
const _0x000e = await _0x0017(_0xstr(340), _0xstr(341), { toNum: toNum });
if (_0x000e.status === _0xstr(342)) {
log(`[TO Quét] Đã copy TO mới: ${toNum} (Operator: ${_0x0094}, Qty: ${_0x00a1})`);
_0x007d = Date.now();
...
_0x0078 = Date.now();
_0x00cf(_0xstr(346));
const res = await _0x0017(_0xstr(347), _0xstr(348));
if (res.status === _0xstr(349) && res.toNum) {
const _0x002c = res.toNum;
log(`[TO In] Lấy mã TO cần in từ Sheet: ${_0x002c}`);
let _0x00c7 = null;
const _0x0070 = document.querySelectorAll(_0xstr(350));
let _0x00c1 = null;
...
_0x00c7 = parent.querySelector(_0xstr(355));
if (_0x00c7) break;
...
const _0x006c = type === _0xstr(364) || type === _0xstr(365) || type === _0xstr(366);
const _0x006d = input.style.display !== _0xstr(367) && input.style.visibility !== _0xstr(368);
return _0x006c && _0x006d;
});
}
if (_0x00c7) {
log(`[TO In] Đang nhập mã TO: ${_0x002c} và nhấn Enter...`);
await _0x00b2(_0x00c7, _0x002c);
await _0x0030(100);
_0x00cf(_0xstr(369));
const _0x009c = await _0x00cc(_0x002c);
if (_0x009c) {
log(`[TO In] Đã in nhãn thành công cho ${_0x002c}`);
_0x007d = Date.now();
try {
await _0x0017(_0xstr(370), _0xstr(371), { toNum: _0x002c });
log(`[TO In] Đã đánh dấu '${_0x002c}' = Đã In trên Sheet.`);
} catch (markErr) {
log(`[TO In] Cảnh báo: Không đánh dấu được Đã In cho ${_0x002c}: ${markErr.message}`);
}
} else {
log(`[TO In] Không bấm được nút in nhãn cho ${_0x002c}`);
}
} else {
...
_0x001d++;
let _0x009b = null;
const _0x0016 = document.querySelectorAll(_0xstr(373));
...
if (!_0x009b) {
const _0x003b = document.querySelectorAll(_0xstr(378));
for (let el of _0x003b) {
const text = el.innerText.trim();
if (text === _0xstr(379) || text === _0xstr(380) || text === _0xstr(381) || text.includes(_0xstr(382))) {
_0x009b = el.closest(_0xstr(383)) || el;
break;
}
}
}
if (_0x009b && !_0x009b.disabled && !_0x009b.classList.contains(_0xstr(384))) {
clearInterval(_0x0020);
log(_0xstr(385));
_0x009b.click();
setTimeout(() => {
log(`[TO In] Đánh dấu 'Đã in' thành công cho ${_0x002c}`);
resolve(true);
}, 800);
} else if (_0x001d > 20) {
clearInterval(_0x0020);
...
_0x0073 = Date.now();
_0x00cf(_0xstr(389));
const data = await _0x0017(_0xstr(390), _0xstr(391));
...
log(`Tìm thấy nhiệm vụ Chuyển Pick: PUP=${pupCode}, Nhận=${recipientDriver} (Gốc: ${_0x00a4})`);
_0x00cf(_0xstr(394));
...
try {
await _0x0017(_0xstr(395), _0xstr(396), { pupCode: pupCode, status: _0xstr(397) });
...
try {
await _0x0017(_0xstr(398), _0xstr(399), { pupCode: pupCode, status: _0xstr(400) });
...
let _0x0045 = null;
const _0x0047 = document.querySelectorAll(_0xstr(402));
for (let _0x006e of _0x0047) {
const _0x006f = _0x006e.querySelector(_0xstr(403));
if (_0x006f) {
const _0x0071 = (_0x006f.innerText || _0x006f.textContent || _0xstr(404)).trim().toLowerCase();
if (_0x0071.includes(_0xstr(405)) || _0x0071.includes(_0xstr(406)) || _0x0071 === _0xstr(407)) {
_0x0045 = _0x006e.querySelector(_0xstr(408));
if (_0x0045) break;
}
}
}
...
await _0x0030(300);
let _0x00b0 = Array.from(document.querySelectorAll(_0xstr(414))).find(btn => {
const _0x00cd = btn.innerText || btn.textContent || _0xstr(415);
return _0x00cd.trim() === _0xstr(416) || _0x00cd.trim() === _0xstr(417);
});
if (_0x00b0) {
_0x00b0.click();
log(_0xstr(418) + pupCode);
} else {
_0x0045.dispatchEvent(new KeyboardEvent(_0xstr(419), { key: _0xstr(420), code: _0xstr(421), keyCode: 13, which: 13, bubbles: true }));
}
await _0x0030(2000);
_0x00cf(_0xstr(422));
const _0x00ae = Array.from(document.querySelectorAll(_0xstr(423)));
let _0x00a6 = false;
for (let _0x00ad of _0x00ae) {
const _0x00a5 = Array.from(_0x00ad.querySelectorAll(_0xstr(424))).find(el => {
const _0x00cd = el.innerText || el.textContent || _0xstr(425);
return _0x00cd.trim() === _0xstr(426) || _0x00cd.trim() === _0xstr(427) || _0x00cd.trim() === _0xstr(428);
});
if (_0x00a5) {
log(_0xstr(429));
_0x00a5.click();
await _0x0030(2500);
_0x00cf(_0xstr(430));
const _0x0037 = document.querySelectorAll(_0xstr(431));
let _0x00c0 = null;
for (const _0x0032 of _0x0037) {
if (_0x0032.offsetWidth > 0 || _0x0032.offsetHeight > 0) {
const text = (_0x0032.innerText || _0x0032.textContent || _0xstr(432));
...
if (_0x00c0) {
let _0x0039 = null;
const _0x0047 = _0x00c0.querySelectorAll(_0xstr(437));
for (let _0x006e of _0x0047) {
const _0x006f = _0x006e.querySelector(_0xstr(438));
if (_0x006f) {
const _0x0071 = (_0x006f.innerText || _0x006f.textContent || _0xstr(439)).trim().toLowerCase();
if (_0x0071.includes(_0xstr(440)) || _0x0071.includes(_0xstr(441))) {
_0x0039 = _0x006e.querySelector(_0xstr(442));
if (_0x0039) break;
}
}
}
if (!_0x0039) {
const _0x0034 = _0x00c0.querySelectorAll(_0xstr(443));
for (let _0x005b of _0x0034) {
const ph = _0x005b.placeholder || _0xstr(444);
...
if (_0x0039) {
const _0x00b1 = _0x0039.closest(_0xstr(448)) || _0x0039.parentElement;
if (_0x00b1) {
_0x00b1.click();
} else {
_0x0039.removeAttribute(_0xstr(449));
_0x0039.click();
}
log(_0xstr(450));
await _0x0030(2200);
...
if (!_0x000d || _0x000d.tagName !== _0xstr(452) || !_0x00c0.contains(_0x000d)) {
_0x000d = _0x0039;
}
...
if (_0x0086) {
_0x0086.click();
log(_0xstr(477) + (_0x0086.innerText || _0x0086.textContent).trim());
await _0x0030(1200);
const _0x0033 = Array.from(_0x00c0.querySelectorAll(_0xstr(478))).find(btn => {
const _0x00cd = btn.innerText || btn.textContent || _0xstr(479);
return _0x00cd.trim() === _0xstr(480) || _0x00cd.trim() === _0xstr(481) || _0x00cd.trim() === _0xstr(482);
});
if (_0x0033) {
_0x0033.click();
log(_0xstr(483));
...
const _0x00b3 = document.querySelectorAll(_0xstr(502));
...
const _0x0016 = Array.from(document.querySelectorAll(_0xstr(512)));
const _0x0053 = _0x0016.some(btn => {
const text = (btn.innerText || btn.textContent || _0xstr(513)).trim().toLowerCase();
const style = window.getComputedStyle(btn);
const _0x006d = btn.offsetWidth > 0 && style.display !== _0xstr(514) && style.visibility !== _0xstr(515);
return _0x006d && (text.includes(_0xstr(516)) || text.includes(_0xstr(517)));
});
const _0x0054 = document.querySelectorAll(_0xstr(518)).length > 0;
return _0x0053 && _0x0054;
}
if (hash.includes(_0xstr(519))) {
const _0x005d = Array.from(document.querySelectorAll(_0xstr(520)));
const _0x0056 = _0x005d.some(input => {
const type = (input.type || _0xstr(521)).toLowerCase();
const style = window.getComputedStyle(input);
const _0x006c = type === _0xstr(522) || type === _0xstr(523) || type === _0xstr(524);
return _0x006c && input.offsetWidth > 0 && style.display !== _0xstr(525) && style.visibility !== _0xstr(526);
});
return _0x0056;
}
if (hash.includes(_0xstr(527))) {
const _0x005d = Array.from(document.querySelectorAll(_0xstr(528)));
const _0x0052 = _0x005d.some(input => {
const style = window.getComputedStyle(input);
return input.offsetWidth > 0 && style.display !== _0xstr(529) && style.visibility !== _0xstr(530);
});
const _0x0016 = Array.from(document.querySelectorAll(_0xstr(531)));
...
const _0x008a = _0x004b();
if (_0x008a) {
const _0x00cb = localStorage.getItem(_0xstr(539) + _0x008a);
if (_0x00cb === _0xstr(540)) {
localStorage.removeItem(_0xstr(541) + _0x008a);
log(`[Hệ thống] Nhận lệnh làm mới tuần tự. Đang đóng tab này...`);
localStorage.setItem(_0xstr(542) + _0x008a, _0xstr(543));
localStorage.removeItem(_0xstr(544) + _0x008a);
window.close();
}
}
}
...
_0x0099 = localStorage.getItem(_0xstr(549)) || GM_getValue(_0xstr(550), _0xstr(551));
_0x0069 = localStorage.getItem(_0xstr(552)) === _0xstr(553);
_0x00d2();
...
let _0x00d9 = null;
try {
const _0x0015 = new Blob([`
function _0x00c3() {
postMessage("pulse");
setTimeout(_0x00c3, 400);
}
_0x00c3();
`], { type: _0xstr(559) });
