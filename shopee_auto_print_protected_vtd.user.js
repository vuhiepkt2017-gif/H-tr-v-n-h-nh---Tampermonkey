...
const _0x009b = hash.split(_0xstr(14))[0];
for (const [type, _0x001c] of Object.entries(_0x000a)) {
if (_0x009b.includes(_0x001c.hashKey)) {
return type;
}
}
return null;
}
let _0x00c1 = sessionStorage.getItem(_0xstr(15));
if (!_0x00c1) {
_0x00c1 = _0xstr(16) + Math.random().toString(36).substring(2, 10) + _0xstr(17) + Date.now();
sessionStorage.setItem(_0xstr(18), _0x00c1);
}
const _0x005b = _0x004e();
if (_0x005b) {
localStorage.setItem(_0xstr(19) + _0x005b, Date.now().toString());
localStorage.setItem(_0xstr(20) + _0x005b, _0x00c1);
}
function _0x0050() {
const _0x0031 = _0x004e();
if (_0x0031) {
const _0x00ac = localStorage.getItem(_0xstr(21) + _0x0031);
if (_0x00ac === _0x00c1) {
...
window.addEventListener(_0xstr(25), _0x0050);
window.addEventListener(_0xstr(26), _0x0050);
function init() {
const _0x0067 = window.opener !== null || window.self !== window.top || window.location.href.includes(_0xstr(27)) || window.location.href.includes(_0xstr(28));
if (_0x0067) {
return;
}
const _0x0000 = _0xstr(29);
let _0x0012 = localStorage.getItem(_0xstr(30)) || GM_getValue(_0xstr(31), _0x0000);
let _0x009e = localStorage.getItem(_0xstr(32)) || GM_getValue(_0xstr(33), _0xstr(34));
let _0x006c = localStorage.getItem(_0xstr(35)) === _0xstr(36);
let _0x0068 = false;
let _0x006a = false;
let _0x006b = false;
let _0x0069 = false;
let _0x0075 = _0xstr(37);
let _0x0077 = 0;
let _0x0082 = _0xstr(38);
let _0x007f = 0;
let _0x0086 = new Set();
let _0x0081 = 0;
let _0x007c = 0;
...
const _0x0087 = _0xstr(39);
const _0x00d3 = _0xstr(40);
const _0x00ca = _0xstr(41);
const _0x002e = localStorage.getItem(_0x00d3);
const _0x0088 = parseInt(localStorage.getItem(_0x00ca) || _0xstr(42));
if (!_0x002e || (now - _0x0088) > 5000 || _0x002e === tabType) {
localStorage.setItem(_0x0087, _0xstr(43));
localStorage.setItem(_0x00d3, tabType);
localStorage.setItem(_0x00ca, now.toString());
return true;
}
return false;
}
function _0x00ae(tabType) {
const _0x0087 = _0xstr(44);
const _0x00d3 = _0xstr(45);
const _0x00ca = _0xstr(46);
const _0x002e = localStorage.getItem(_0x00d3);
if (_0x002e === tabType) {
localStorage.removeItem(_0x0087);
localStorage.removeItem(_0x00d3);
localStorage.removeItem(_0x00ca);
_0x007e = Date.now();
}
}
function _0x00d4(tabType) {
const _0x00d3 = _0xstr(47);
const _0x00ca = _0xstr(48);
const _0x002e = localStorage.getItem(_0x00d3);
if (_0x002e === tabType) {
localStorage.setItem(_0x00ca, Date.now().toString());
}
}
GM_registerMenuCommand(_0xstr(49), function() {
let _0x0090 = prompt(_0xstr(50), _0x0012);
if (_0x0090) {
_0x0012 = _0x0090.trim();
...
const _0x0083 = document.createElement(_0xstr(54));
_0x0083.id = _0xstr(55);
_0x0083.innerText = _0xstr(56);
_0x0083.style = _0xstr(57);
document.body.appendChild(_0x0083);
const _0x009a = document.createElement(_0xstr(58));
_0x009a.id = _0xstr(59);
_0x009a.style = _0xstr(60);
let _0x0014 = null;
function _0x00b9() {
_0x00be();
_0x0014 = setTimeout(() => {
...
function _0x002a() {
_0x009a.style.display = _0xstr(61);
_0x0083.style.display = _0xstr(62);
_0x00be();
}
function _0x0045() {
_0x009a.style.display = _0xstr(63);
_0x0083.style.display = _0xstr(64);
_0x00b9();
}
_0x009a.innerHTML = `
...
<_0x0072 style="display: block; margin-bottom: 4px; color: #aaa;">Link Google Web App:</_0x0072>
...
<_0x0072 style="display: block; margin-bottom: 4px; color: #aaa;">Tên Máy Tính (PC Name):</_0x0072>
<input type="text" id="ap-pc-input" style="width: 93%; padding: 6px; border-radius: 4px; border: 1px solid #555; background-color: #2a2a35; color: white; font-size: 11px;" value="${_0x009e}">
</div>
...
<_0x0072 style="display: block; margin-bottom: 6px; color: #ff9800; font-weight: bold;">Trạng thái các Tab (Auto-Open):</_0x0072>
...
`;
document.body.appendChild(_0x009a);
const _0x00cf = document.createElement(_0xstr(65));
_0x00cf.innerHTML = `
#shopee-auto-print-_0x009a, #shopee-auto-print-_0x0083 {
transition: opacity 0.25s ease-in-out;
}
`;
document.head.appendChild(_0x00cf);
function _0x0021() {
let _0x0058 = false;
const _0x003a = document.querySelectorAll(_0xstr(66));
for (let i = 0; i < _0x003a.length; i++) {
const el = _0x003a[i];
...
if (_0x0058) {
_0x009a.style.opacity = _0xstr(72);
_0x009a.style.pointerEvents = _0xstr(73);
} else {
if (_0x009a.style.display !== _0xstr(74)) {
_0x009a.style.opacity = _0xstr(75);
_0x009a.style.pointerEvents = _0xstr(76);
}
}
if (_0x0083.style.display !== _0xstr(77)) {
_0x0083.style.opacity = _0xstr(78);
_0x0083.style.pointerEvents = _0xstr(79);
}
}
setInterval(_0x0021, 300);
const _0x0089 = document.getElementById(_0xstr(80));
const _0x0016 = document.getElementById(_0xstr(81));
const _0x00cd = document.getElementById(_0xstr(82));
const _0x00da = document.getElementById(_0xstr(83));
const _0x009c = document.getElementById(_0xstr(84));
const _0x00b4 = document.getElementById(_0xstr(85));
const _0x0027 = document.getElementById(_0xstr(86));
const _0x002d = document.getElementById(_0xstr(87));
const _0x00db = document.getElementById(_0xstr(88));
const _0x00d9 = document.getElementById(_0xstr(89));
const _0x003d = document.getElementById(_0xstr(90));
const _0x00dc = document.getElementById(_0xstr(91));
const _0x00c3 = document.getElementById(_0xstr(92));
const _0x0095 = document.getElementById(_0xstr(93));
function log(message) {
const _0x00c9 = new Date().toLocaleTimeString();
_0x0089.innerHTML = `[${_0x00c9}] ${message}<br>` + _0x0089.innerHTML;
const _0x0085 = _0x0089.innerHTML.split(_0xstr(94));
if (_0x0085.length > 20) _0x0089.innerHTML = _0x0085.slice(0, 20).join(_0xstr(95));
}
function _0x00d7() {
if (_0x006c) {
_0x0016.innerText = _0xstr(96);
_0x0016.style.backgroundColor = _0xstr(97);
_0x00cd.innerText = _0xstr(98);
_0x00cd.style.backgroundColor = _0xstr(99);
} else {
_0x0016.innerText = _0xstr(100);
_0x0016.style.backgroundColor = _0xstr(101);
_0x00cd.innerText = _0xstr(102);
_0x00cd.style.backgroundColor = _0xstr(103);
}
}
function _0x00d8() {
if (_0x0012 && _0x0012 !== _0x0000) {
_0x00d9.style.display = _0xstr(104);
_0x00db.style.display = _0xstr(105);
_0x00dc.innerText = _0xstr(106);
} else {
_0x00d9.style.display = _0xstr(107);
_0x00db.style.display = _0xstr(108);
}
}
function _0x00d5() {
const _0x0031 = _0x004e();
...
localStorage.setItem(_0xstr(110) + _0x0031, _0x00c1);
}
}
...
function _0x00d6() {
_0x00c3.innerHTML = _0xstr(111);
const now = Date.now();
for (const [type, _0x001c] of Object.entries(_0x000a)) {
const _0x007d = parseInt(localStorage.getItem(_0xstr(112) + type) || _0xstr(113));
const _0x006e = _0x007d > 0 && (now - _0x007d) < _0x000b;
const _0x0071 = document.createElement(_0xstr(114));
_0x0071.style = `display: flex; align-items: center; justify-content: space-between; padding: 4px 6px; border-radius: 4px; background-color: ${_0x006e ? 'rgba(76, 175, 80, 0.15)' : 'rgba(244, 67, 54, 0.15)'}; border: 1px solid ${_0x006e ? '#4caf50' : '#f44336'}; font-size: 11px;`;
_0x0071.innerHTML = `
<span style="font-weight: bold; color: ${_0x006e ? '#81c784' : '#e57373'};">${_0x001c.name}</span>
<span style="font-size: 9px; padding: 1px 4px; border-radius: 3px; background-color: ${_0x006e ? '#4caf50' : '#f44336'}; color: white;">
${_0x006e ? 'Mở' : 'Tắt'}
</span>
`;
_0x0071.style.cursor = _0xstr(115);
_0x0071.title = `Bấm để mở tab ${_0x001c.name}`;
_0x0071.addEventListener(_0xstr(116), () => {
...
function _0x005c(_0x00d0) {
const now = Date.now();
const _0x0044 = localStorage.getItem(_0xstr(124));
if (_0x0044) {
if (_0x00d0 === _0xstr(125)) {
log(_0xstr(126));
_0x0026();
} else {
const _0x00bd = parseInt(localStorage.getItem(_0xstr(127)) || _0xstr(128));
...
if (_0x00d0 === _0xstr(130)) {
localStorage.setItem(_0xstr(131) + type, _0xstr(132));
_0x00c4.push(type);
} else {
const _0x007d = parseInt(localStorage.getItem(_0xstr(133) + type) || _0xstr(134));
const _0x0062 = _0x007d > 0 && (now - _0x007d) < _0x000b;
if (!_0x0062) {
_0x00c4.push(type);
}
}
...
if (_0x00c4.length === 0) {
if (_0x00d0 === _0xstr(135)) log(_0xstr(136));
return;
}
localStorage.removeItem(_0xstr(137));
log(`[Mở Tab] ▶ Bắt đầu mở tuần tự ${_0x00c4.length} tab: ${_0x00c4.map(t => _0x000a[t]?.name || t).join(' → ')}`);
localStorage.setItem(_0xstr(138), JSON.stringify(_0x00c4));
localStorage.setItem(_0xstr(139), _0x00c4[0]);
...
const _0x0049 = _0x00c4[0];
const _0x001c = _0x000a[_0x0049];
localStorage.setItem(_0xstr(144) + _0x0049, now.toString());
const _0x008e = _0x004e();
if (_0x008e === _0x0049) {
...
let _0x00a7;
try {
_0x00a7 = JSON.parse(localStorage.getItem(_0xstr(153)) || _0xstr(154));
} catch(e) {
_0x0026();
return;
}
_0x00a7.shift();
if (_0x00a7.length > 0) {
const _0x0091 = _0x00a7[0];
const _0x001c = _0x000a[_0x0091];
const now = Date.now();
localStorage.setItem(_0xstr(155), JSON.stringify(_0x00a7));
localStorage.setItem(_0xstr(156), _0x0091);
localStorage.setItem(_0xstr(157), _0xstr(158));
localStorage.setItem(_0xstr(159), now.toString());
localStorage.setItem(_0xstr(160) + _0x0091, now.toString());
...
function _0x004f() {
const _0x00a8 = localStorage.getItem(_0xstr(165));
if (!_0x00a8) return;
let _0x00a7;
try {
_0x00a7 = JSON.parse(_0x00a8);
} catch(e) {
_0x0026();
return;
}
if (!Array.isArray(_0x00a7) || _0x00a7.length === 0) {
_0x0026();
return;
}
const _0x0030 = localStorage.getItem(_0xstr(166));
const _0x008e = _0x004e();
if (!_0x008e || _0x008e !== _0x0030) return;
const _0x009f = localStorage.getItem(_0xstr(167));
if (_0x009f !== _0xstr(168)) return;
const _0x00c2 = parseInt(localStorage.getItem(_0xstr(169)) || _0xstr(170));
const now = Date.now();
if (_0x0066()) {
log(`[Mở Tab] ✓ Tab ${_0x000a[_0x008e]?.name || _0x008e} đã load đầy đủ và sẵn sàng!`);
_0x0080 = Date.now();
_0x0097();
return;
}
if ((now - _0x00c2) > _0x0006) {
const _0x00b1 = parseInt(localStorage.getItem(_0xstr(171)) || _0xstr(172));
if (_0x00b1 < 1) {
log(`[Mở Tab] ⚠ Tab ${_0x000a[_0x008e]?.name || _0x008e} load quá 45s. Thử reload lại...`);
localStorage.setItem(_0xstr(173), _0xstr(174));
localStorage.setItem(_0xstr(175), now.toString());
window.location.reload();
} else {
log(`[Mở Tab] ✗ Tab ${_0x000a[_0x008e]?.name || _0x008e} không thể load. Bỏ qua...`);
...
let _0x0052 = false;
let _0x0054 = false;
let _0x004c = _0xstr(179);
for (const [type, _0x001c] of Object.entries(_0x000a)) {
const _0x007d = parseInt(localStorage.getItem(_0xstr(180) + type) || _0xstr(181));
const _0x00ad = localStorage.getItem(_0xstr(182) + type);
const _0x006e = _0x007d > 0 && (now - _0x007d) < _0x000b;
if (!_0x006e) {
const _0x0079 = parseInt(localStorage.getItem(_0xstr(183) + type) || _0xstr(184));
const _0x007a = now - _0x0079;
if (_0x00ad && _0x007a > 60000) {
_0x0054 = true;
_0x004c = type;
break;
}
if (!_0x00ad) {
if (_0x007d === 0 && _0x007a > _0x0003) {
_0x0052 = true;
break;
}
if (_0x007d > 0 && (now - _0x007d) > _0x0005 && _0x007a > _0x0005) {
_0x0052 = true;
break;
}
}
...
const _0x0099 = _0x0013.createOscillator();
const _0x004d = _0x0013.createGain();
_0x0099.type = _0xstr(196);
_0x0099.frequency.value = 20000;
_0x004d.gain.value = 0.0001;
_0x0099.connect(_0x004d);
_0x004d.connect(_0x0013.destination);
_0x0099.start();
log(_0xstr(197));
} catch (e) {
...
if (document.visibilityState === _0xstr(205) && _0x006c) {
_0x00b0();
}
});
_0x0095.addEventListener(_0xstr(206), _0x0096);
_0x00d7();
_0x00d8();
if (_0x006c) {
_0x003f();
const _0x005a = () => {
if (_0x006c) _0x003f();
document.removeEventListener(_0xstr(207), _0x005a);
};
document.addEventListener(_0xstr(208), _0x005a);
}
_0x003d.addEventListener(_0xstr(209), () => {
_0x00d9.style.display = _0xstr(210);
_0x00db.style.display = _0xstr(211);
_0x00da.focus();
});
_0x00b4.addEventListener(_0xstr(212), () => {
const _0x005f = _0x00da.value.trim();
const _0x009d = _0x009c.value.trim() || _0xstr(213);
if (_0x005f && !_0x005f.includes(_0xstr(214))) {
_0x0012 = _0x005f;
_0x009e = _0x009d;
localStorage.setItem(_0xstr(215), _0x0012);
localStorage.setItem(_0xstr(216), _0x009e);
GM_setValue(_0xstr(217), _0x0012);
GM_setValue(_0xstr(218), _0x009e);
log(`Đã lưu cấu hình. PC: ${_0x009e}`);
_0x00d8();
alert(_0xstr(219));
} else {
alert(_0xstr(220));
...
_0x006c = !_0x006c;
localStorage.setItem(_0xstr(223), _0x006c ? [_0xstr(224)] : _0xstr(225));
_0x00d7();
log(_0x006c ? [_0xstr(226)] : _0xstr(227));
if (_0x006c) {
_0x003f();
_0x0096();
} else {
...
_0x00cd.addEventListener(_0xstr(228), _0x00ce);
_0x0016.addEventListener(_0xstr(229), _0x00ce);
_0x0027.addEventListener(_0xstr(230), _0x002a);
_0x0083.addEventListener(_0xstr(231), _0x0045);
_0x009a.addEventListener(_0xstr(232), _0x00be);
_0x009a.addEventListener(_0xstr(233), _0x00be);
_0x009a.addEventListener(_0xstr(234), _0x00be);
_0x009a.addEventListener(_0xstr(235), _0x00be);
_0x009a.addEventListener(_0xstr(236), _0x00b9);
function _0x0033(ms) {
...
async function _0x00b7(inputEl, value) {
try {
inputEl.focus();
} catch (e) {}
const _0x008f = Object.getOwnPropertyDescriptor(window.HTMLInputElement.prototype, _0xstr(237))?.set;
if (_0x008f) {
_0x008f.call(inputEl, value);
} else {
inputEl.value = value;
}
...
let _0x00c7 = _0xstr(250);
if (method === _0xstr(251)) {
_0x00c7 = `${_0x0025}?action=${urlOrAction}&pc=${encodeURIComponent((_0x009e || "").trim())}`;
} else {
_0x00c7 = _0x0025;
}
let isSettled = false;
...
isSettled = true;
clearTimeout(timer);
reject(new Error(`Lỗi kết nối mạng đến ${_0x00c7}`));
},
ontimeout: function() {
if (isSettled) return;
isSettled = true;
...
options.data = JSON.stringify(Object.assign({ action: urlOrAction, pc: (_0x009e || _0xstr(255)).trim() }, data));
}
...
_0x00d4(_0xstr(265));
const _0x00c0 = await _0x0043(_0x0029);
if (_0x00c0) {
_0x0080 = Date.now();
...
const _0x00d2 = _0x0018.innerText || _0x0018.textContent || _0xstr(276);
return _0x00d2.trim().toLowerCase() === _0xstr(277);
});
if (!_0x002c) return false;
_0x002c.click();
let _0x0064 = false;
let _0x0053 = false;
let _0x0041 = _0xstr(278);
const _0x00dd = codes.filter(c => c.startsWith(_0xstr(279)) || c.startsWith(_0xstr(280)) || c.startsWith(_0xstr(281)) || /^[A-Z0-9]{8,25}$/.test(c));
for (let i = 0; i < 40; i++) {
await _0x0033(50);
const _0x000f = Array.from(document.querySelectorAll(_0xstr(282)));
const _0x004b = _0x000f.find(el => {
const _0x00d2 = el.textContent.trim().toUpperCase();
return _0x00dd.some(vc => _0x00d2 === vc || _0x00d2.includes(vc));
});
if (_0x004b) {
_0x0064 = true;
}
...
_0x0053 = true;
_0x0041 = _0x0039.trim().replace(/\n/g, _0xstr(290));
const _0x0085 = _0x0039.split(_0xstr(291)).map(l => l.trim().toUpperCase());
const _0x0061 = [];
for (const _0x0084 of _0x0085) {
const _0x008b = _0x0084.match(/(SPXVN\d+|TETS\d+|VN\d+|[A-Z0-9]{8,25})/g);
if (_0x008b) {
for (const match of _0x008b) {
...
const _0x0028 = _0x0061.length > 0 ? _0x0061 : codes;
const _0x0092 = Array.from(_0x0035.querySelectorAll(_0xstr(295))).find(_0x0018 => {
const _0x00d2 = (_0x0018.innerText || _0x0018.textContent || _0xstr(296)).trim().toLowerCase();
return _0x00d2 === _0xstr(297) || _0x00d2 === _0xstr(298) || _0x00d2 === _0xstr(299) || _0x00d2 === _0xstr(300) || _0x00d2 === _0xstr(301) || _0x00d2.includes(_0xstr(302));
});
if (_0x0092) {
const _0x0093 = 800 + Math.random() * 200;
setTimeout(() => {
_0x0092.click();
log(`[In Bill] Đã click nút OK đóng cảnh báo.`);
}, _0x0093);
log(`[In Bill] Phát hiện _0x0035 lỗi. Đợi ${(_0x0093/1000).toFixed(2)} giây để tự động đóng...`);
}
for (const _0x0040 of _0x0028) {
_0x001a(_0xstr(303), _0xstr(304), { code: _0x0040, status: _0xstr(305) })
.then(() => {
log(`[In Bill] Đã báo cáo thành công mã lỗi: '${_0x0040}' = 'Mã lỗi'.`);
})
.catch(e => {
log(`[In Bill] Gặp lỗi khi gửi báo cáo cho ${_0x0040}: ${e.message}`);
});
}
break;
}
...
const _0x00a0 = Array.from(document.querySelectorAll(_0xstr(307))).find(el => {
const _0x00d2 = el.innerText || el.textContent || _0xstr(308);
return _0x00d2.trim() === _0xstr(309);
});
if (!_0x00a0) return false;
...
const _0x00d2 = _0x0018.innerText || _0x0018.textContent || _0xstr(312);
return _0x00d2.trim() === _0xstr(313);
});
if (_0x0038) {
_0x0065 = true;
break;
...
const now = Date.now();
if (now - _0x007f > 2000) {
let _0x00b5 = Array.from(document.querySelectorAll(_0xstr(315))).find(_0x0018 => {
...
if (_0x0086.size === 0 || (now - _0x0081) > 60000) {
try {
...
_0x0081 = now;
log(`[TO Quét] Đã đồng bộ ${_0x0086.size} mã TO đã tồn tại từ Excel.`);
}
} catch (e) {
...
const _0x00b3 = document.querySelectorAll(_0xstr(334));
for (let _0x00b2 of _0x00b3) {
const _0x001b = _0x00b2.querySelectorAll(_0xstr(335));
if (_0x001b.length > 0) {
let toNum = _0xstr(336);
let _0x0098 = _0xstr(337);
let _0x00a6 = -1;
if (_0x00cb !== -1 && _0x001b[_0x00cb]) toNum = _0x001b[_0x00cb].innerText.trim();
if (_0x0094 !== -1 && _0x001b[_0x0094]) _0x0098 = _0x001b[_0x0094].innerText.trim();
if (_0x00a5 !== -1 && _0x001b[_0x00a5]) {
const _0x00a4 = parseInt(_0x001b[_0x00a5].innerText.trim(), 10);
if (!isNaN(_0x00a4)) _0x00a6 = _0x00a4;
}
if (!toNum) {
_0x001b.forEach(c => {
const _0x00d2 = c.innerText.trim();
if (/^TO\d+[A-Z0-9]+$/i.test(_0x00d2)) toNum = _0x00d2;
});
}
if (!_0x0098) {
_0x001b.forEach(c => {
const _0x00d2 = c.innerText.trim();
if (_0x00d2.includes(_0xstr(338))) _0x0098 = _0x00d2;
});
}
if (_0x00a6 === -1) {
_0x001b.forEach((c, idx) => {
const _0x00d2 = c.innerText.trim();
if (/^\d+$/.test(_0x00d2) && idx > 0 && idx !== _0x00cb) {
const _0x00a4 = parseInt(_0x00d2, 10);
if (_0x00a4 > 0) _0x00a6 = _0x00a4;
}
});
}
if (toNum && _0x0098 && _0x00a6 > 0) {
const _0x006d = _0x0098.toLowerCase() === _0xstr(339);
if (!_0x006d && !_0x0086.has(toNum.toLowerCase())) {
_0x0086.add(toNum.toLowerCase());
try {
const _0x000e = await _0x001a(_0xstr(340), _0xstr(341), { toNum: toNum });
if (_0x000e.status === _0xstr(342)) {
log(`[TO Quét] Đã copy TO mới: ${toNum} (Operator: ${_0x0098}, Qty: ${_0x00a6})`);
_0x0080 = Date.now();
...
async function _0x00a2() {
if (!_0x006c || _0x006b) return;
...
let _0x00cc = null;
const _0x0073 = document.querySelectorAll(_0xstr(350));
let _0x00c6 = null;
for (let el of _0x0073) {
...
if (_0x00c6) {
let parent = _0x00c6.parentElement;
for (let i = 0; i < 3 && parent; i++) {
_0x00cc = parent.querySelector(_0xstr(355));
if (_0x00cc) break;
...
_0x00cc = _0x0011.find(input => {
const type = (input.type || _0xstr(363)).toLowerCase();
const _0x006f = type === _0xstr(364) || type === _0xstr(365) || type === _0xstr(366);
const _0x0070 = input.style.display !== _0xstr(367) && input.style.visibility !== _0xstr(368);
return _0x006f && _0x0070;
});
}
if (_0x00cc) {
log(`[TO In] Đang nhập mã TO: ${_0x002f} và nhấn Enter...`);
await _0x00b7(_0x00cc, _0x002f);
await _0x0033(100);
_0x00d4(_0xstr(369));
const _0x00a1 = await _0x00d1(_0x002f);
if (_0x00a1) {
...
if (!_0x00a0) {
const _0x003e = document.querySelectorAll(_0xstr(378));
for (let el of _0x003e) {
const text = el.innerText.trim();
if (text === _0xstr(379) || text === _0xstr(380) || text === _0xstr(381) || text.includes(_0xstr(382))) {
_0x00a0 = el.closest(_0xstr(383)) || el;
break;
}
}
}
if (_0x00a0 && !_0x00a0.disabled && !_0x00a0.classList.contains(_0xstr(384))) {
...
const _0x00a9 = data.recipientDriver;
const recipientDriver = _0x0046(_0x00a9);
const now = Date.now();
if (pupCode === _0x0075 && (now - _0x0077) < 30000) {
log(`PUP ${pupCode} đã được xử lý gần đây (dưới 30s). Bỏ qua thao tác trùng lặp.`);
_0x0069 = false;
_0x00ae(_0xstr(393));
return;
}
log(`Tìm thấy nhiệm vụ Chuyển Pick: PUP=${pupCode}, Nhận=${recipientDriver} (Gốc: ${_0x00a9})`);
_0x00d4(_0xstr(394));
const _0x00c0 = await _0x0042(pupCode, recipientDriver);
if (_0x00c0) {
_0x0075 = pupCode;
_0x0077 = Date.now();
...
async function _0x0042(pupCode, recipientDriver) {
let _0x0048 = null;
const _0x004a = document.querySelectorAll(_0xstr(402));
for (let _0x0071 of _0x004a) {
const _0x0072 = _0x0071.querySelector(_0xstr(403));
if (_0x0072) {
const _0x0074 = (_0x0072.innerText || _0x0072.textContent || _0xstr(404)).trim().toLowerCase();
if (_0x0074.includes(_0xstr(405)) || _0x0074.includes(_0xstr(406)) || _0x0074 === _0xstr(407)) {
_0x0048 = _0x0071.querySelector(_0xstr(408));
if (_0x0048) break;
}
}
}
...
await _0x00b7(_0x0048, pupCode);
await _0x0033(300);
let _0x00b5 = Array.from(document.querySelectorAll(_0xstr(414))).find(_0x0018 => {
const _0x00d2 = _0x0018.innerText || _0x0018.textContent || _0xstr(415);
return _0x00d2.trim() === _0xstr(416) || _0x00d2.trim() === _0xstr(417);
});
if (_0x00b5) {
_0x00b5.click();
log(_0xstr(418) + pupCode);
} else {
_0x0048.dispatchEvent(new KeyboardEvent(_0xstr(419), { key: _0xstr(420), code: _0xstr(421), keyCode: 13, which: 13, bubbles: true }));
}
await _0x0033(2000);
_0x00d4(_0xstr(422));
const _0x00b3 = Array.from(document.querySelectorAll(_0xstr(423)));
let _0x00ab = false;
for (let _0x00b2 of _0x00b3) {
const _0x00aa = Array.from(_0x00b2.querySelectorAll(_0xstr(424))).find(el => {
const _0x00d2 = el.innerText || el.textContent || _0xstr(425);
return _0x00d2.trim() === _0xstr(426) || _0x00d2.trim() === _0xstr(427) || _0x00d2.trim() === _0xstr(428);
});
if (_0x00aa) {
log(_0xstr(429));
_0x00aa.click();
...
if (_0x00c5) {
let _0x003c = null;
const _0x004a = _0x00c5.querySelectorAll(_0xstr(437));
for (let _0x0071 of _0x004a) {
const _0x0072 = _0x0071.querySelector(_0xstr(438));
if (_0x0072) {
const _0x0074 = (_0x0072.innerText || _0x0072.textContent || _0xstr(439)).trim().toLowerCase();
if (_0x0074.includes(_0xstr(440)) || _0x0074.includes(_0xstr(441))) {
_0x003c = _0x0071.querySelector(_0xstr(442));
if (_0x003c) break;
}
}
}
if (!_0x003c) {
const _0x0037 = _0x00c5.querySelectorAll(_0xstr(443));
for (let _0x005e of _0x0037) {
const ph = _0x005e.placeholder || _0xstr(444);
...
if (_0x003c) {
const _0x00b6 = _0x003c.closest(_0xstr(448)) || _0x003c.parentElement;
if (_0x00b6) {
_0x00b6.click();
} else {
...
if (!_0x000d || _0x000d.tagName !== _0xstr(452) || !_0x00c5.contains(_0x000d)) {
_0x000d = _0x003c;
}
...
if (_0x008a) {
_0x008a.click();
log(_0xstr(477) + (_0x008a.innerText || _0x008a.textContent).trim());
await _0x0033(1200);
const _0x0036 = Array.from(_0x00c5.querySelectorAll(_0xstr(478))).find(_0x0018 => {
const _0x00d2 = _0x0018.innerText || _0x0018.textContent || _0xstr(479);
return _0x00d2.trim() === _0xstr(480) || _0x00d2.trim() === _0xstr(481) || _0x00d2.trim() === _0xstr(482);
});
if (_0x0036) {
_0x0036.click();
log(_0xstr(483));
...
function _0x001d() {
const now = Date.now();
if (_0x0068 && _0x007c > 0 && (now - _0x007c) > _0x0009) {
log(_0xstr(488));
_0x0068 = false;
_0x00ae(_0xstr(489));
_0x007c = 0;
}
if (_0x006a && _0x0078 > 0 && (now - _0x0078) > _0x0009) {
log(_0xstr(490));
_0x006a = false;
_0x00ae(_0xstr(491));
_0x0078 = 0;
}
if (_0x006b && _0x007b > 0 && (now - _0x007b) > _0x0009) {
log(_0xstr(492));
_0x006b = false;
_0x00ae(_0xstr(493));
_0x007b = 0;
}
if (_0x0069 && _0x0076 > 0 && (now - _0x0076) > _0x0009) {
log(_0xstr(494));
_0x0069 = false;
_0x00ae(_0xstr(495));
_0x0076 = 0;
...
const _0x00b8 = document.querySelectorAll(_0xstr(502));
for (const sp of _0x00b8) {
...
const _0x0056 = _0x0019.some(_0x0018 => {
const text = (_0x0018.innerText || _0x0018.textContent || _0xstr(513)).trim().toLowerCase();
const style = window.getComputedStyle(_0x0018);
const _0x0070 = _0x0018.offsetWidth > 0 && style.display !== _0xstr(514) && style.visibility !== _0xstr(515);
return _0x0070 && (text.includes(_0xstr(516)) || text.includes(_0xstr(517)));
});
const _0x0057 = document.querySelectorAll(_0xstr(518)).length > 0;
return _0x0056 && _0x0057;
}
if (hash.includes(_0xstr(519))) {
const _0x0060 = Array.from(document.querySelectorAll(_0xstr(520)));
const _0x0059 = _0x0060.some(input => {
const type = (input.type || _0xstr(521)).toLowerCase();
const style = window.getComputedStyle(input);
const _0x006f = type === _0xstr(522) || type === _0xstr(523) || type === _0xstr(524);
return _0x006f && input.offsetWidth > 0 && style.display !== _0xstr(525) && style.visibility !== _0xstr(526);
});
return _0x0059;
}
if (hash.includes(_0xstr(527))) {
const _0x0060 = Array.from(document.querySelectorAll(_0xstr(528)));
const _0x0055 = _0x0060.some(input => {
const style = window.getComputedStyle(input);
...
const _0x008e = _0x004e();
if (_0x008e) {
const _0x00d0 = localStorage.getItem(_0xstr(539) + _0x008e);
if (_0x00d0 === _0xstr(540)) {
localStorage.removeItem(_0xstr(541) + _0x008e);
log(`[Hệ thống] Nhận lệnh làm mới tuần tự. Đang đóng tab này...`);
localStorage.setItem(_0xstr(542) + _0x008e, _0xstr(543));
localStorage.removeItem(_0xstr(544) + _0x008e);
window.close();
}
}
}
...
const _0x0063 = !_0x0068 && !_0x006a && !_0x006b && !_0x0069;
if (_0x0063 && (now - _0x0080) > _0x0001) {
_0x005d();
}
}
let _0x008d = 0;
...
_0x009e = localStorage.getItem(_0xstr(549)) || GM_getValue(_0xstr(550), _0xstr(551));
_0x006c = localStorage.getItem(_0xstr(552)) === _0xstr(553);
_0x00d7();
...
function _0x00c8() {
postMessage("pulse");
setTimeout(_0x00c8, 400);
}
_0x00c8();
`], { type: _0xstr(559) });
const _0x00df = URL.createObjectURL(_0x0017);
_0x00de = new Worker(_0x00df);
_0x00de.onmessage = function(e) {
